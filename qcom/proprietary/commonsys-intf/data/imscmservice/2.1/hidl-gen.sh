...
# com.qualcomm.qti.imscmservice@2.1 service

HIDL_ROOT_DIR="$QCPATH/ims-ship/rcs/interfaces/imscmservice"
LIBHIDL_COMPONENT='-r android.hidl:system/libhidl/transport'

IMS_CM_INTERFACE_LIB='com.qualcomm.qti.imscmservice@2.1'

LOC="$QCPATH/ims-ship/rcs/interfaces/imscmservice/2.1/default"
