...
ifeq ($(call is-board-platform-in-list,msm8960 msm8974 msm8226 msm8610 apq8084 msm8994 msm8992 msm8916 msm8909 msm8996 msm8952 msm8937 thorium msm8953 msmgold msm8998 apq8098_latv sdm450 sdm660 sdm845 sdm710 qcs605 msmnile $(MSMSTEPPE) $(TRINKET) kona),true)
...
include $(CLEAR_VARS)
LOCAL_MODULE       := ftm_test_config_trinket-tasha-snd-card
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_OWNER := qti
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES    := config/trinket/ftm_test_config_trinket-tasha-snd-card
include $(BUILD_PREBUILT)
