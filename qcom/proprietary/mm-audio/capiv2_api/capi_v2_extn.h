...
typedef struct sva_threshold_config {
    uint32_t struct_size;
    int32_t smm_threshold;
} sva_threshold_config_t;


typedef struct sva_rms_threshold_config {
    uint32_t struct_size;
    int32_t rms_threshold;
} sva_rms_threshold_config_t;

typedef struct sva_result {
    uint32_t struct_size;
    uint32_t reserved;
    int32_t is_detected;
...
typedef struct sva_config {
    uint32_t struct_size;
    uint32_t sample_rate;
    uint32_t frame_samples;
} sva_config_t;

typedef struct sva_memory_config {
    uint32_t struct_size;
...
typedef struct sva_end_detection_frames_config {
    uint32_t struct_size;
