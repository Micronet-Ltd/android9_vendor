...
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/General_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/Global_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/Handset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/Hdmi_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/Headset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/Speaker_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/
LOCAL_SRC_FILES         := QRD/$(TARGET_PRODUCT)/workspaceFile.qwsp
include $(BUILD_PREBUILT)
