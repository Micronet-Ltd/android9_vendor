...
===========================================================================*/
/*===========================================================================
  FUNCTION  netmgr_tc_deinit_lock
===========================================================================*/
/*!
@brief
  De-init mutex lock
...
@return
  NETMGR_FAILURE if mutex de-init fails
...
*/
/*=========================================================================*/
static int netmgr_tc_deinit_lock(void)
{
  int ret = 0;

  ret = pthread_mutex_destroy(&tc_lock);
  if (0 != ret)
  {
    netmgr_log_err("%s(): failed to detroy mutex ! Err: %d", __func__, ret);
