...
#define NETMGR_MAIN_KO_PROPERTY_SET   "1"
...
netmgr_ctl_port_array[NETMGR_MAX_LINK+1] =
{
  ...
  {"DATA15_CNTL", QMI_PORT_RMNET_8,         NETMGR_LINK_RMNET_8,      FALSE, TRUE},
  {"DATA16_CNTL", QMI_PORT_RMNET_9,         NETMGR_LINK_RMNET_9,      FALSE, TRUE},
  {"DATA17_CNTL", QMI_PORT_RMNET_10,        NETMGR_LINK_RMNET_10,     FALSE, TRUE},

  /* SDIO/USB transport */
  {"MDM0_CNTL",   QMI_PORT_RMNET_SDIO_0,    NETMGR_LINK_RMNET_11,     TRUE,  TRUE},
  {"MDM1_CNTL",   QMI_PORT_RMNET_SDIO_1,    NETMGR_LINK_RMNET_12,     FALSE, TRUE},
  {"MDM2_CNTL",   QMI_PORT_RMNET_SDIO_2,    NETMGR_LINK_RMNET_13,     FALSE, TRUE},
  {"MDM3_CNTL",   QMI_PORT_RMNET_SDIO_3,    NETMGR_LINK_RMNET_14,     FALSE, TRUE},
  {"MDM4_CNTL",   QMI_PORT_RMNET_SDIO_4,    NETMGR_LINK_RMNET_15,     FALSE, TRUE},
  {"MDM5_CNTL",   QMI_PORT_RMNET_SDIO_5,    NETMGR_LINK_RMNET_16,     FALSE, TRUE},
  {"MDM6_CNTL",   QMI_PORT_RMNET_SDIO_6,    NETMGR_LINK_RMNET_17,     FALSE, TRUE},
  {"MDM7_CNTL",   QMI_PORT_RMNET_SDIO_7,    NETMGR_LINK_RMNET_18,     FALSE, TRUE},
  {"MDM8_CNTL",   QMI_PORT_RMNET_SDIO_8,    NETMGR_LINK_RMNET_19,     FALSE, TRUE},
  {"MDM9_CNTL",   QMI_PORT_RMNET_SDIO_9,    NETMGR_LINK_RMNET_20,     FALSE, TRUE},
  {"MDM10_CNTL",  QMI_PORT_RMNET_SDIO_10,   NETMGR_LINK_RMNET_21,     FALSE, TRUE},
...
{
#ifdef FEATURE_DATA_IWLAN
    netmgr_main_dev_prefix_tbl[0][0].inst_min = NETMGR_LINK_RMNET_0;
    netmgr_main_dev_prefix_tbl[0][0].inst_max = (NETMGR_LINK_RMNET_0 + netmgr_main_cfg.num_data_ports - 1);

    netmgr_main_dev_prefix_tbl[0][1].inst_min = NETMGR_LINK_REV_RMNET_0;
    netmgr_main_dev_prefix_tbl[0][1].inst_max = (NETMGR_LINK_REV_RMNET_0 + netmgr_main_cfg.num_rev_data_ports - 1);

    netmgr_main_dev_prefix_tbl[1][0].inst_min = NETMGR_LINK_RMNET_11;
    netmgr_main_dev_prefix_tbl[1][0].inst_max = (NETMGR_LINK_RMNET_11 + netmgr_main_cfg.num_data_ports - 1);

    netmgr_main_dev_prefix_tbl[1][1].inst_min = NETMGR_LINK_REV_RMNET_9;
    netmgr_main_dev_prefix_tbl[1][1].inst_max = (NETMGR_LINK_REV_RMNET_9 + netmgr_main_cfg.num_rev_data_ports - 1);
#else
    netmgr_main_dev_prefix_tbl[0].inst_min = NETMGR_LINK_RMNET_0;
    netmgr_main_dev_prefix_tbl[0].inst_max = (NETMGR_LINK_RMNET_0 + netmgr_main_cfg.num_data_ports - 1);

    netmgr_main_dev_prefix_tbl[1].inst_min = NETMGR_LINK_RMNET_11;
    netmgr_main_dev_prefix_tbl[1].inst_max = (NETMGR_LINK_RMNET_11 + netmgr_main_cfg.num_data_ports - 1);
#endif
}
...
*/
/*=========================================================================*/
int netmgr_main_unset_ko_loading_properties(ds_target_t target)
{
  int reti = NETMGR_SUCCESS;
  ...
  default:
    /* Nothing to do for other targets */
    break;
  }
  ...
  case DS_TARGET_FUSION_SM8150_SDX50:
    {
      if (netmgr_restart)
      {
        ...
        netmgr_main_unset_ko_loading_properties(target);
      }

      /* Set SHS KO property */
      if (netmgr_main_cfg.rmnet_shs && NETMGR_SUCCESS
            != netmgr_rmnet_set_ko_loading_property(NETMGR_MAIN_SHS_KO_PROPERTY,
                                                    NETMGR_MAIN_KO_PROPERTY_SET))
      {
        reti = NETMGR_FAILURE;
      }
    ...
    break; /* DS_TARGET_SOC_ID_MSMNILE or DS_TARGET_FUSION_SM8150_SDX50 */
