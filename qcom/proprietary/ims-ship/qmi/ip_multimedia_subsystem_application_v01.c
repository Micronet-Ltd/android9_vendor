...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/imsa/src/ip_multimedia_subsystem_application_v01.c#18 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t imsa_ind_reg_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, voice_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, voice_config_valid)),
  0x1E,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry imsa_service_command_messages_v01[] = {
  ...
  {QMI_IMSA_IND_REG_REQ_V01, QMI_IDL_TYPE16(0, 4), 60},
