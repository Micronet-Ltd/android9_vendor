...
ifeq ($(call is-vendor-board-platform,QCOM),true)
  ...
  CODECV1_LIST += msmcobalt
  CODECV1_LIST += msmfalcon
  ...
  ifeq ($(call is-board-platform-in-list,$(CODECV1_LIST)),true)
    ifeq ($(call is-board-platform-in-list,msm8974 msm8916 msm8952 msm8226 msm8610 apq8084 mpq8092 msm_bronze msm8994 msm8996 msm8992 tellurium msm8909 msm8937 msm8953 msmcobalt msmfalcon),true)
      JPEGD_VER := jpeg10
      JPEGE_VER := jpeg10
      FACT_VER := codecB
