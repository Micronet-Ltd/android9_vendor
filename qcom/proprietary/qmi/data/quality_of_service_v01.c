...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/qos/src/quality_of_service_v01.c#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t qos_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, suppress_report_flow_control) - QMI_IDL_OFFSET8(qos_indication_register_req_msg_v01, suppress_report_flow_control_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry qos_service_command_messages_v01[] = {
  ...
  {QMI_QOS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 38), 8},
