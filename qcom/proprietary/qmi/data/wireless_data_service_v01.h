...
#define WDS_V01_IDL_MINOR_VERS 0x9E
...
typedef struct {
  ...
  uint32_t profile_list_len;  /**< Must be set to # of elements in profile_list */
  wds_profile_lite_info_type_v01 profile_list[QMI_WDS_PROFILE_LIST_MAX_V01];
  /**<   This TLV is present if the result code is QMI_RESULT_SUCCESS.*/
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Trusted Remote UE Source L2 Information List */
