...
public class QcNvItemTypes {
    ...
    public static final int SIZE_OF_NV_FACTORY_DATA_3_I = 128;
    ...
    public static class NvFactoryData3I extends BaseQCNvItemType {
   		...
   		NvFactoryData3I(byte[] bArray) {
           ByteBuffer buf = createByteBuffer(bArray);
           bytes = buf.array();
       }

       public int getSize() {
           return SIZE_OF_NV_FACTORY_DATA_3_I;
       }

       public String toDebugString() {
           return String.format("size=%d", bytes.length);
       }
    ...
    //xiaciping add for set MEID and IMEI
    // meid
    public static class NvMeidType extends BaseQCNvItemType {
   		...
   		NvMeidType(byte[] bArray) {
           ByteBuffer buf = createByteBuffer(bArray);
           bytes = buf.array();
       }

        public void setMeid(String in) throws InvalidParameterException {
    ...
    public static class NvIMEIType extends BaseQCNvItemType {
   		...
   		NvIMEIType(byte[] bArray) {
           ByteBuffer buf = createByteBuffer(bArray);
           bytes = buf.array();
       }

        public void setImei(String in) throws InvalidParameterException {
 ...
 // some primitive types
    public static class NvSmsAuto extends BaseQCNvItemType {
	 ...
	 byte[]  bytes;
        ...
        NvSmsAuto(byte[] bArray) {
            ByteBuffer buf = createByteBuffer(bArray);
	     bytes = buf.array();
        }

        public int getSize() {
            return SIZE_OF_NV_SMSAUTO;
        }
