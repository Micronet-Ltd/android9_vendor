/******************************************************************************
 * @file    QcNvItemsIds.java
 * @brief   Contains NV Item IDs used in the Modem.
 *
 * ---------------------------------------------------------------------------
...
public class QcNvItemIds {
    ...
    public static final int NV_MEID_CD_I = 1992;

    public static final int NV_FACTORY_DATA_1_I = 2497;

    public static final int NV_VENDOR_TCL_CU_REFERENCE_NUMBER_I = 7233;
    
    public static final int NV_FACTORY_DATA_3_I = 2499;

    public static final int NV_UE_IMEI2_I = 551;

    public static final int NV_UE_BT_ADDR_I = 447;

    public static final int NV_UE_WLAN_ADDR_I = 4678;

    public static final int NV_SET_SAR_RF_STATE = 5000;
}
