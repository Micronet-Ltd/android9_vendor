...
def main(argv):
    ...
    # Start scanning
    scan_tag = "\r"+"["+TAG+"]"+" Scanning makefiles..."
    print(scan_tag, end="")
    sys.stdout.flush()
    ...
    for dir in scan_dirs:
        for root, dirs, filenames in os.walk(dir):
            ...
            for filename in filenames:
                # Print animation while we scan through all files.
                time_now = time.time()
    ...
    print("\n")
    log("Scanning completed for " + str(numScanned) + " makefiles. Comparing with last violation check...", True, True)
    sys.stdout.flush()
    old_violations = {}
