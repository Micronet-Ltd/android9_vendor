...
{
public:
    ~GeofenceLocationAPIClient() {pthread_mutex_destroy(&mGeofenceLock);}
    GeofenceLocationAPIClient() {pthread_mutex_init(&mGeofenceLock, NULL);}
