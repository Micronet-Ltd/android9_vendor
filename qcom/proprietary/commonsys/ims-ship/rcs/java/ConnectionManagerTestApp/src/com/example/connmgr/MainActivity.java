...
import com.qualcomm.qti.imscmservice.V2_1.IImsCmService;
import com.qualcomm.qti.imscmservice.V2_1.IImsCmServiceListener;
...
import com.qualcomm.qti.imscmservice.V2_0.deviceConfigKeys;
        ...
        public void onClick(View arg0) {
            ...
            try
            {
                ...
                if (ConnectionGlobalData.connMgrInitialised == 1)
                {
                  ...
                  status = ConnectionGlobalData.oldConnMgr.getConfiguration(
                                    ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                    ConnectionGlobalData.autoConfigType,
                                    ConnectionGlobalData.userDataArray[ConnectionGlobalData.activeWorkingSub]);
                 }
          ...
          public void onClick(View v) {
            try {
              if (ConnectionGlobalData.connMgrInitialised == 1){
                  ...
                  iRetValue = ConnectionGlobalData.oldConnMgr.methodResponse(
                                                           ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                                           data,
                                                           ConnectionGlobalData.userDataArray[ConnectionGlobalData.activeWorkingSub]);
                  }
           ...
           public void onClick(View v) {
               try {
                ...
                try{
                   ...
                   Log.d(TAG, "ImsCmServiceImpl.InitializeService old modem, fallback to oldclient");
                   ConnectionGlobalData.connMgr = null;
                   ConnectionGlobalData.oldConnMgr = com.qualcomm.qti.imscmservice.V2_0.IImsCmService.getService("qti.ims.connectionmanagerservice");
                   }
                   if(ConnectionGlobalData.connMgr !=null){
                   Log.d(TAG, "ImsCmServiceImpl.InitializeService called newclient");
                   ConnectionGlobalData.currVersion = ConnectionGlobalData.newClient;
                   }
                   else{
                   Log.d(TAG, "ImsCmServiceImpl.InitializeService called oldclient");
                   ConnectionGlobalData.currVersion = ConnectionGlobalData.oldClient;
                   }
                   Log.d(TAG, "ImsCmServiceImpl.InitializeService called");
                   if(ConnectionGlobalData.oldConnMgr == null && ConnectionGlobalData.connMgr ==null){
                   Log.d(TAG, "ERROR: ImsCmServiceImpl.InitializeService called | oldclient newclient both null, return");
                   ...
                   for( int i=0; i < subInfoList.size(); i++) {
                      ...
                      if(ConnectionGlobalData.currVersion == ConnectionGlobalData.newClient && ConnectionGlobalData.connMgr != null){
                      ...
                      /* calls onServiceReady Callback and populates serviceHandle */
                       //inal int initStatus;
                       ConnectionGlobalData.connMgr.InitializeService_2_1(
                                                              mIccId,
                                                              connMgrListener,
					  ...
					  if( (ConnectionGlobalData.currVersion == ConnectionGlobalData.oldClient && ConnectionGlobalData.oldConnMgr != null)){
                       ...
                       int initStatus2 = 0;
                       ConnectionGlobalData.oldConnMgr.InitializeService(
                                                              mIccId,
                                                              connMgrListener_2_0,
                                                              ConnectionGlobalData.userDataArray[i],
                                                              (int status, long listenerId) -> {
               ...
               try{
                       if ( ConnectionGlobalData.connMgrInitialised == 1)
                       {
                           ...
                           ConnectionGlobalData.connMgr.createConnection(
                                   ...
                                   ConnectionGlobalData.oldConnMgr.createConnection(
                                   ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                   ConnectionGlobalData.connSmListenerMap.get(ConnectionGlobalData.activeWorkingSub),
                                   ConnectionGlobalData.SM_FEATURE_TAG,
                                   (IImsCMConnection connection, long connectionHandle, long listenerToken) -> {
                ...
                try{
                        ...
                        if (ConnectionGlobalData.connMgrInitialised == 1)
                        {
                            ...
                            iRetValue = ConnectionGlobalData.connMgr.triggerRegistration(
                                ...
                                iRetValue = ConnectionGlobalData.oldConnMgr.triggerRegistration(
                                ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                ConnectionGlobalData.userDataArray[ConnectionGlobalData.activeWorkingSub]);
                            }
            ...
            public void onClick(View v) {
                try{
                        ...
                        if (ConnectionGlobalData.connMgrInitialised == 1)
                        {
                            ...
                            iRetValue = ConnectionGlobalData.oldConnMgr.triggerDeRegistration(
                                ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                ConnectionGlobalData.userDataArray[ConnectionGlobalData.activeWorkingSub]);
                            }
                        ...
                        ConnectionGlobalData.connSmMap.get(ConnectionGlobalData.activeWorkingSub) != null )
                    {
                             ...
                             ConnectionGlobalData.connSmInitialisedArray[ConnectionGlobalData.activeWorkingSub] == 1)
                        {
                            ...
                            {   //Marshall KeyValueStringType data
                                ...
                                keyValuePairStringType callIdType = new keyValuePairStringType();
                                callIdType.key = outgoingMessageKeys.CallId;
                                callIdType.value = "3486455304_1570329456@[2002:c023:9c17:401e::3]";
                                msg.data.add(callIdType);
        ...
        connMgrButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                try{
                    ...
                    else if(ConnectionGlobalData.oldConnMgr != null){
                    if (ConnectionGlobalData.connMgrListenerMap_2_0.get(ConnectionGlobalData.activeWorkingSub)!= null )
                        {
                            ...
                            ConnectionGlobalData.oldConnMgr.removeListener(
                                ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                ConnectionGlobalData.connMgrListenerMap_2_0.get(ConnectionGlobalData.activeWorkingSub).
                                getListenerId());
                        }
                        ...
                        /* Closes the Connection Manager.
                           Closing the manager forces pending connection objects to be
                           immediately deleted regardless of what state they are in*/
                        ConnectionGlobalData.oldConnMgr.closeService(
                            ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub]);
                    }
                    else
                    {
                ...
                try{
                    if (ConnectionGlobalData.connSmMap.get(ConnectionGlobalData.activeWorkingSub) != null )
                    {
                        if ( ConnectionGlobalData.connMgrInitialised == 1)
                        {
                            ...
                            ConnectionGlobalData.oldConnMgr.closeConnection(
                                ConnectionGlobalData.serviceHandleArray[ConnectionGlobalData.activeWorkingSub],
                                ConnectionGlobalData.connSmMap.get(ConnectionGlobalData.activeWorkingSub).connectionHandle);
                            }
                        }
