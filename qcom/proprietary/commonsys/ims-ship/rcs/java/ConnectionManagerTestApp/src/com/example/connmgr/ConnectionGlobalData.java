...
public class ConnectionGlobalData  {
    ...
    public static HashMap<Integer, ConnectionManagerListenerImpl_2_0> connMgrListenerMap_2_0 = new HashMap<Integer, ConnectionManagerListenerImpl_2_0>();
    ...
    public static int oldClient = 1;
    public static int newClient = 2;
    public static int currVersion;
    public static com.qualcomm.qti.imscmservice.V2_0.IImsCmService oldConnMgr;
