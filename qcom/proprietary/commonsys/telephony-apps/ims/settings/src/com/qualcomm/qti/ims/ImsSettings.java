...
public class ImsSettings extends PreferenceActivity
    ...
    private int getVideoQuality() {
        ...
        try {
            if (mImsConfig != null) {
                videoQuality = mImsConfig.getConfigInt(
    ...
    private boolean setVideoQuality(int quality) {
        ...
        try {
            if (mImsConfig != null) {
                result = mImsConfig.setConfig(ImsConfig.ConfigConstants.VIDEO_QUALITY,
                        quality);
            }
        } catch (ImsException e) {
    ...
    private void setRttMode(boolean enabling) {
        ...
        try {
            if (mImsConfig != null) {
                mImsConfig.setConfig(ImsConfig.ConfigConstants.RTT_SETTING_ENABLED,
                        enabling ? 1 : 0);
            }
        } catch (ImsException e) {
