                                    ...
                                    for (SuppSvcResponse.BarredLines lines : barredLines) {
                                        if (!barredLines.isEmpty()) {
                                            ...
                                            for (SuppSvcResponse.LineStatus lineStatus : line) {
                                                ...
                                                ssInfo.mIcbNum = lineStatus.getNumber();
                                                ssInfo.mStatus = lineStatus.getStatus();
                                                ssInfoArray.add(ssInfo);
                                            }
                                        }
                                    }
                ...
                case EVENT_QUERY_CLIP:
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            ImsSsInfo ssInfo = new ImsSsInfo();
                            ssInfo.mStatus = clipStatus.getStatus();
                ...
                case EVENT_QUERY_COLR:
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            ImsSsInfo ssInfo = new ImsSsInfo();
                            ssInfo.mStatus = colr.getStatus();
                            Log.i(this, "Service= " + msg.what + " status= "
                                + ssInfo.mStatus);

                            ssInfo.mProvisionStatus = colr.getProvisionStatus();
                            Log.i(this, "Service= " + msg.what + " Provision Status= "
                                + ssInfo.mProvisionStatus);
                    ...
                    if (ar != null) {
                        ...
                        if (ar.exception != null) {
                            ...
                            if(sipError != null) {
                                ...
                                ssInfo.mProvisionStatus = response.getProvisionStatus();
                                Log.i(this, "Service= " + msg.what + " provision Status= "
                                        + ssInfo.mProvisionStatus);
