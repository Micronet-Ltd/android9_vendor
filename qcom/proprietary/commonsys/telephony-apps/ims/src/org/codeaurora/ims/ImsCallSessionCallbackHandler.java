...
public class ImsCallSessionCallbackHandler {
   ...
   /**
    ...
    public void callSessionPropertyChanged(final int property) {
        postRunnable(() -> {
            if (mListener != null) {
                try {
                    Log.i(this, "callSessionPropertyChanged :: property=" + property);
                    mListener.callSessionPropertyChanged(property);
                } catch (RuntimeException r) {
                    Log.e(this, "callSessionPropertyChanged :: RuntimeException " + r);
                }
            }
        });
    }
