...
public class ImsCallUtils {
   ...
   /** Checks if a call is incoming call
    ...
    /**
     * Utility function to set the bits that are specified by the mask that's passed in
     *
     * @param property The call session property
     * @param mask The bits to set
     * @return int The call session property with the bits specified in the mask being set
     * for e.g if mask is 0x0011 and property was initially 0x0100, we would return 0x0111
     *
     * @hide
     */
    public static int setBits(int property, int mask) {
        return property | mask;
    }

    /**
     * Utility function to clear the bits that are specified by the mask that's passed in
     *
     * @param property The call session property
     * @param mask The bits to clear
     * @return int The call session property with the bits specified in the mask being cleared
     *
     * @hide
     */
    public static int clearBits(int property, int mask) {
        return property & ~(mask);
    }
}
