...
public class ImsCallSessionImpl extends ImsCallSessionImplBase {
    ...
    public ImsCallSessionCallbackHandler mCallbackHandler = new ImsCallSessionCallbackHandler();
    ...
    private void maybeCreateVideoProvider(boolean isVideoCallingEnabled) {
        if ((QtiImsExtUtils.isRttSupported(mPhoneId, mContext) || isVideoCallingEnabled ||
                isRttSupported()) && (mImsCallModification == null)) {
    ...
    public void handleHandover(int hoType, int srcTech, int targetTech,
        ...
        switch (hoType) {
            ...
            case HoInfo.COMPLETE_SUCCESS:
                mCallbackHandler.callSessionHandover(srcTech, targetTech,
                        new ImsReasonInfo(error, 0, errorMessage));
                /**
            ...
            case HoInfo.COMPLETE_FAIL:
                ...
                mCallbackHandler.callSessionHandoverFailed(srcTech, targetTech,
                        new ImsReasonInfo(error, 0, errorMessage));
                break;
            ...
            case HoInfo.NOT_TRIGGERED_MOBILE_DATA_OFF:
                mCallbackHandler.callSessionMayHandover(srcTech, targetTech);
                break;
            default:
                ...
                case EVENT_DIAL:
                    ...
                    if (ar != null && ar.exception != null) {
                        ...
                        if(ar.userObj != null) {
                            ...
                            mCallbackHandler.callSessionInitiatedFailed(
    ...
    private void inviteParticipant(String participant) {
        ...
        mCi.addParticipant(participant, CommandsInterface.CLIR_DEFAULT, null,
    ...
    public void notifyReceivedRttMessage(Object result) {
        if (!isSessionValid() || (mDc.state != DriverCallIms.State.ACTIVE)) {
            return;
        }
    ...
    private void notifyVoiceInfoChanged(int message) {
        ...
        if (message == VoiceInfo.VOICE_INFO_SPEECH) {
            property = ImsCallUtils.setBits(property, Connection.PROPERTY_RTT_AUDIO_SPEECH);
        } else if (message == VoiceInfo.VOICE_INFO_SILENT) {
            property = ImsCallUtils.clearBits(property, Connection.PROPERTY_RTT_AUDIO_SPEECH);
        }

        Log.i(this, "notifyVoiceInfoChanged: Call session property = " + property);
        if (mCallProperty == property) {
            return;
        }
        mCallProperty = property;
        mCallbackHandler.callSessionPropertyChanged(mCallProperty);
    }
}
