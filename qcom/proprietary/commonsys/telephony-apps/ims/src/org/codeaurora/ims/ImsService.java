...
public class ImsService extends android.telephony.ims.ImsService {
    ...
    private void setup() {
        ...
        for (int i = 0; i < numSlots; i++) {
            ...
            mServiceSubs[i] = new ImsServiceSub(this, i, mSenderRxrs[i], mSubController, phone.mCi);
        }

        final int defaultSub = 0;
        ImsVideoGlobals.init(mServiceSubs[defaultSub], this);

        // Initialize the QtiImsExt
        mQtiImsExt = new QtiImsExt(this, mServiceSubs);
    }
