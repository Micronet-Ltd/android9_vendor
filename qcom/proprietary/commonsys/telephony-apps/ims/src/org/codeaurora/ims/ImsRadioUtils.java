...
public class ImsRadioUtils {
    ...
    public static DriverCallIms buildDriverCallImsFromHal(
            vendor.qti.hardware.radio.ims.V1_4.CallInfo call) {
    ...
    public static ImsReasonInfo sipErrorFromHal(SipErrorInfo errorInfo) {
        ImsReasonInfo sipErrorInfo = new ImsReasonInfo();
        if (errorInfo.errorCode != Integer.MAX_VALUE) {
            sipErrorInfo.mExtraCode = errorInfo.errorCode;
        }
        sipErrorInfo.mExtraMessage = errorInfo.errorString;
        return sipErrorInfo;
    }
