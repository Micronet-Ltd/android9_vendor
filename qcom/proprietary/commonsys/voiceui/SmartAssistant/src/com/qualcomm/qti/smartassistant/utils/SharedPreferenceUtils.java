...
public class SharedPreferenceUtils {
    ...
    private static final String SECOND_DETECTION_ENABLED = "second_detection_enabled";
    ...
    public static boolean getIsSecondDetectionEnabled(Context context) {
        SharedPreferences prefs = getDefaultSharedPreferences(context);
        return prefs.getBoolean(SECOND_DETECTION_ENABLED, false);
    }

    public static void setIsSecondDetectionEnabled(Context context,
                                                         boolean enabled) {
        SharedPreferences prefs = getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putBoolean(SECOND_DETECTION_ENABLED, enabled);
        editor.apply();
    }
    ...
    private final static String FIRST_DETECTION_COUNT = "first_detection_count";
    private final static String SECOND_DETECTION_COUNT = "second_detection_count";

    public static void increaseFirstDetectionCount() {
        setFirstDetectionCount(getFirstDetectionCount() + 1);
    }

    public static int getFirstDetectionCount() {
        SharedPreferences prefs = getDefaultSharedPreferences(SmartAssistantApplication.getInstance());
        return prefs.getInt(FIRST_DETECTION_COUNT, 0);
    }

    public static void resetFirstDetectionCount() {
        setFirstDetectionCount(0);
    }

    private static void setFirstDetectionCount(int count) {
        SharedPreferences prefs = getDefaultSharedPreferences(SmartAssistantApplication.getInstance());
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(FIRST_DETECTION_COUNT, count);
        editor.apply();
    }

    public static void increaseSecondDetectionCount() {
        setSecondDetectionCount(getSecondDetectionCount() + 1);
    }

    public static int getSecondDetectionCount() {
        SharedPreferences prefs = getDefaultSharedPreferences(SmartAssistantApplication.getInstance());
        return prefs.getInt(SECOND_DETECTION_COUNT, 0);
    }

    public static void resetSecondDetectionCount() {
        setSecondDetectionCount(0);
    }

    private static void setSecondDetectionCount(int count) {
        SharedPreferences prefs = getDefaultSharedPreferences(SmartAssistantApplication.getInstance());
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(SECOND_DETECTION_COUNT, count);
        editor.apply();
    }
}
