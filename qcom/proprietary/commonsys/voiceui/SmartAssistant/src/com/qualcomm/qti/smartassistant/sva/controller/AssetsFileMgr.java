...
public class AssetsFileMgr {
    private static final String TAG = AssetsFileMgr.class.getSimpleName();
    private static final String SUFFIX_SNOWBOY_RES = ".res";
    private static final String SUFFIX_SNOWBOY_UMDL = ".umdl";
    ...
    private String[] copyAssets(Context context, String destDir) {
        if (null == destDir || !FileUtils.isFileExist(destDir)) {
