...
public class VoiceSdkHelper {
    ...
    public VoiceSdkHelper(Context context,BaseAudioRecorder audioRecorder){
        mContext = context;
        mVoiceSdkImpl = new DuerVoiceSdkImpl(context, audioRecorder);
    }
    ...
    public void startRecognition(){
        try {
            ...
            mVoiceSdkImpl.startRecognition();
