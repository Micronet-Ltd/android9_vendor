...
class PmcGetConfigResponse: public JsonResponse
{
    public:
        PmcGetConfigResponse(const Json::Value& jsonRequestValue, Json::Value& jsonResponseValue) : JsonResponse("PmcGetConfigResponse", jsonRequestValue, jsonResponseValue)
        {
