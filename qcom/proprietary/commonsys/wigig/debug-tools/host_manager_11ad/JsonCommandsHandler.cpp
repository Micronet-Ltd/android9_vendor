...
{
    LOG_VERBOSE << ">>> Json String (command): " << jsonString << std::endl;
    ...
    try
    {
        ...
        LOG_DEBUG << ">>> JSON Request: " << root << std::endl;
