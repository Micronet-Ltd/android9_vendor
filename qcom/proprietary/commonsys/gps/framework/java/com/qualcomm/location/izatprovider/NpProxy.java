...
public class NpProxy implements Handler.Callback {
    ...
    private void setNpImplePackageNames() {
        ...
        String defaultServicePackageName =
                SystemProperties.get("ro.location.osnlp.package", "com.google.android.gms");
        String regionServicePackageName =
                SystemProperties.get("ro.location.osnlp.region.package", "");
    ...
    private void initServiceBinding() {
        if (null == mOSNpHandle) {
            mOSNpHandle = LocationProviderProxy
                    .createAndBind(mContext, LocationManager.NETWORK_PROVIDER,
        ...
        if (null == mRegionOSNpHandle) {
            mRegionOSNpHandle = LocationProviderProxy
                    .createAndBind(mContext, LocationManager.NETWORK_PROVIDER,
                                   NETWORK_LOCATION_SERVICE_ACTION,
                                   R.bool.config_enableNpOverlay,
                                   mRegionalOsnlpResId,
    ...
    private void updateServiceBinding() {
        LocationProviderInterface curHandle = mActiveNpHandle;
    ...
    private LocationProviderInterface mOSNpHandle;
    private LocationProviderInterface mRegionOSNpHandle;
    private LocationProviderInterface mActiveNpHandle;
    ...
    private static final int mNpImplIds[][] = {
            {R.string.config_OSNP_PackageName, R.array.config_OSNP_NpPackageNames},
            ...
            {R.string.config_regional_OSNP_AutoNavi_PackageName,
             R.array.config_AutoNavi_NpPackageNames},
            {R.string.config_regional_OSNP_Tencent_PackageName,
             R.array.config_Tencent_NpPackageNames},
            {R.string.config_regional_OSNP_AutoNavi_PackageName_1,
             R.array.config_AutoNavi_NpPackageNames_1}};
