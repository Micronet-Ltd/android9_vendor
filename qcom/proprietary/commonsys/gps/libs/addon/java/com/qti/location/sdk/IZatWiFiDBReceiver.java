...
@{ */
 ...
 /** APIs for
 * injecting a Wi-Fi AP location database to an IZat location framework.
 *
 */
...
@{ */
     ...
     *
     * This interface
     * receives responses from a Wi-Fi database receiver in an IZat
     * location framework.
     */
    public interface IZatWiFiDBReceiverResponseListener {
        /**
         * Responses to an AP list request.
         * <p>
         ...
         * Applications should implement this interface.</p>
         *
         * @param[out] is_success Injection of AP locations success or
         *                   failure.
         * @param[out] error Error details if the AP location injection
         *                   failed.
         *
         * @return
         * None.
...
@{ */
    ...
    public static class IZatCellInfo {
        ...
        /**
         * Enumeration of IZat cell types. Values: \n
         * GSM \n
         * CDMA \n
         * WCDMA \n
         * LTE
...
@{ */
    ...
    public static class IZatAPLocationData {
        ...
        /**
         * Enumeration of IZat reliablity types. Values: \n
         * VERY_LOW \n
         * LOW \n
         * MEDIUM \n
         * HIGH \n
         ...
         *
         * @param reliability Reliability values: \n
         *  - VERY_LOW -- The probability of a position outlier is 1 in one
         *  hundred or even more likely
         *  - LOW -- The probability of a position outlier is about 1 in a
         *  thousand
         *  - MEDIUM -- The probability of a position outlier is about 1 in a
         *  100 thousand
         *  - HIGH -- The probability of a position outlier is about 1 in
         *  10 million
         *  - VERY HIGH -- The probability of a position outlier is about 1 in
         *  a thousand million \n
...
@{ */
    ...
    public static class IZatAPSpecialInfo {
        ...
        /**
         * Enumeration of IZatAPSpecialInfoTypes. Values: \n
         * NO_INFO_AVAILABLE \n
         * MOVING_AP
         */
