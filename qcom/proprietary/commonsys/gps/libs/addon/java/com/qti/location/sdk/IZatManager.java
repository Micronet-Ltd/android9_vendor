...
public class IZatManager {
     ...
     * @return
     * The version of SDK and Service
     */
     ...
     *
     * This API may take several seconds.
    ...
    /**
     * Get a {@link IZatTestService} interface of Test service.
     * <p>
     * This api requires IZat test service be present, otherwise
     * a {@link IZatServiceUnavailableException}<br/>
     * will be thrown.<br/>
     * This api may take as long as several seconds.
     * It is recommended not to call this api in main thread.
     * Only system app is allowed to call this api.
     * </p>
     *
     * @throws IZatServiceUnavailableException if the test Service does not present.
     * @throws IZatSecurityException if the callling app is not system app.
    ...
    /**
     * Disconnect from the specified {@link IZatTestService} interface.
     *
   ...
   public void disconnectDebugReportingService(IZatDebugReportingService service) {
    ...
    /**
     * Get a {@link IZatWWANDBReceiver} interface of WWAN DB
     * Receiver.
     * <p>
     * This api requires WWAN DB Receiver be present, otherwise
     * a {@link IZatServiceUnavailableException}<br/>
     * will be thrown.<br/>
     * This api may take as long as several seconds.
     * It is recommended not to call this api in main thread.
     * </p>
     *
     * @throws IZatServiceUnavailableException if the WWAN DB
     *                                         Receiver is not
     *                                         present.
     * @param service handle object that is returned from
    ...
    /**
     * Disconnect the specified {@link IZatWWANDBReceiver}
     * interface.
     *
     * @throws IZatIllegalArgumentException if the input receiver is null.
     *
