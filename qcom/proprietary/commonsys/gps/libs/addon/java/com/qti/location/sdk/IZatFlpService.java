...
/**
 * The IZatFlpService provides the interface for interacting with the IZat FLP service.
 *
 * <pre>
 * <code>
 *
 ...
 *                public void onClick(View v) {
 *
 *                    // start an FLP position session with time interval and distance interval
 *                    if (mFlpSevice != null) {
 *
...
/** @addtogroup IZatFlpService
    ...
    public enum IzatFlpStatus {
        ...
        /**
         * Applications will receive a POSITION_NOT_AVAILABLE once if the underlying engine
...
/** @addtogroup IZatFlpService
    ...
    interface IFlpStatusCallback {
         ...
         *
         * @param[out] status Batching status sent back from the engine,
