...
LOCAL_SHARED_LIBRARIES := libc libcutils libutils liblog libmmi libxml2 libft2 libicuuc libui libbinder libgui libhwui libc++ libc_malloc_debug
LOCAL_SHARED_LIBRARIES += libbase libutils libhidlbase libhidltransport libhwbinder vendor.qti.hardware.factory@1.0
...
LOCAL_SHARED_LIBRARIES := libcutils liblog libmmi libdiag_system libc++ libc_malloc_debug
LOCAL_SHARED_LIBRARIES += libbase libutils libhidlbase libhidltransport libhwbinder vendor.qti.hardware.factory@1.0
LOCAL_HEADER_LIBRARIES := libdiag_headers
