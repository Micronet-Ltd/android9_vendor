...
public class KeyphraseListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            rowViewHolder.mSwitch.setOnCheckedChangeListener(
                    new CompoundButton.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                            LogUtils.d(TAG, "switch check status = " + checked);
                        }
                    });
        ...
        switch (version) {
            case VERSION_2_0:
                settings += " " + mContext.getString(R.string.model) + "2.0";
                break;
            case VERSION_3_0:
                settings += " " + mContext.getString(R.string.model) + "3.0";
                break;
            default:
                settings += " " + mContext.getString(R.string.model) + "unknown";
                break;
        }
