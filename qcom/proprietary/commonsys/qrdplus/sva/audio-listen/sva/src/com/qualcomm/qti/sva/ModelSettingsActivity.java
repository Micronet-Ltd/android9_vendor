...
public class ModelSettingsActivity extends Activity {
    ...
    private EditText mEtGMMKeyphrase;
    private RelativeLayout mLayoutGMMUser;
    private EditText mEtGMMUser;
    private RelativeLayout mLayoutCNNKeyphrase;
    private EditText mEtCNNKeyphrase;
    private RelativeLayout mLayoutVOPUser;
    private EditText mEtVOPUser;
    ...
    private void initializeUI() {
        mEtGMMKeyphrase = findViewById(R.id.et_gmm_keyphrase);
        mEtGMMKeyphrase.setText(String.valueOf(mSettingModel.getGMMKeyphraseConfidenceLevel()));
        mEtGMMKeyphrase.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                try {
                    mSettingModel.setGMMKeyphraseConfidenceLevel(Integer.valueOf(s.toString()));
        ...
        mLayoutCNNKeyphrase = findViewById(R.id.layout_cnn_confidence_level);
        mEtCNNKeyphrase = findViewById(R.id.et_cnn_keyphrase);
        mEtCNNKeyphrase.setText(String.valueOf(mSettingModel.getCNNKeyphraseConfidenceLevel()));
        mEtCNNKeyphrase.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            ...
            public void afterTextChanged(Editable s) {
                try {
                    mSettingModel.setCNNKeyphraseConfidenceLevel(Integer.valueOf(s.toString()));
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
            }
        ...
        if (ISmModel.MODEL_VERSION.VERSION_2_0 == mSmVersion) {
            mLayoutCNNKeyphrase.setVisibility(View.GONE);
        } else {
            mLayoutCNNKeyphrase.setVisibility(View.VISIBLE);
        }

        mLayoutGMMUser = findViewById(R.id.layout_gmm_user);
        mEtGMMUser = findViewById(R.id.et_gmm_user);
        mEtGMMUser.setText(String.valueOf(mSettingModel.getGMMUserConfidenceLevel()));
        mEtGMMUser.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            ...
            public void afterTextChanged(Editable s) {
                try {
                    mSettingModel.setGMMUserConfidenceLevel(Integer.valueOf(s.toString()));
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
            }
        ...
        if (!mIsTrainedModel) {
            mLayoutGMMUser.setVisibility(View.GONE);
        }

        mLayoutVOPUser = findViewById(R.id.layout_vop_user_confidence_level);
        mEtVOPUser = findViewById(R.id.et_vop_user);
        mEtVOPUser.setText(String.valueOf(mSettingModel.getVOPUserConfidenceLevel()));
        mEtVOPUser.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            ...
            public void afterTextChanged(Editable s) {
                try {
                    mSettingModel.setVOPUserConfidenceLevel(Integer.valueOf(s.toString()));
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
            }
        ...
        if (ISmModel.MODEL_VERSION.VERSION_2_0 == mSmVersion) {
            mLayoutVOPUser.setVisibility(View.GONE);
        } else {
            if (mIsTrainedModel) {
                mLayoutVOPUser.setVisibility(View.VISIBLE);
            } else {
                mLayoutVOPUser.setVisibility(View.GONE);
            }
        }
