...
public class MainActivity extends ServiceActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        debugModeItem.setVisible(Global.isSvaDebugModeEnabled());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.menu_item_debug_mode:
                if (Global.isSvaDebugModeEnabled()) {
    ...
    private void showSelectKeyphraseDialog() {
        ...
        for (IExtendedSmModel item : mTrainableSmList) {
            keyphraseList.add(item.getSoundModelPrettyKeyphrase());
        }
        ...
        keyphraseList.add(getString(R.string.create_your_own));
        ...
        dialogBuilder.setTitle(getString(R.string.select_one_keyphrase))
                ...
                .setPositiveButton(R.string.next, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        if (-1 == mSelectedIndex || mSelectedIndex > mTrainableSmList.size()) {
                            Toast.makeText(getApplicationContext(),
                        ...
                        if (mSelectedIndex == mTrainableSmList.size()) {
                            // selected create your own ..
                            smName = getString(R.string.create_your_own);
                        } else {
                            smName = mTrainableSmList.get(
                                    mSelectedIndex).getSoundModelFullFileName();
                        }
    ...
    private void showNextDialog(final String smName) {
        LogUtils.d(TAG, "showNextDialog: smName = " + smName);
        boolean isUdk = false;
        if (getString(R.string.create_your_own).equals(smName)) {
            isUdk = true;
        }
        ...
        dialogBuilder.setView(view)
                ...
                .setPositiveButton(R.string.next, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        boolean isUdk = getString(R.string.create_your_own).equals(smName);
