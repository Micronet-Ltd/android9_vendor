...
public class TrainingActivity extends Activity {
    ...
    private boolean isUdk() {
        ...
        return getString(R.string.create_your_own).equals(mPreviousSmName);
    }

    private String getKeyphrase() {
        String keyphrase;
        boolean bUdk = getString(R.string.create_your_own).equals(mPreviousSmName);
        if (!bUdk) {
            if (mIsAddUserToPreviousSm) {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            if (isUdk()) {
                int snr = ListenSoundModel.verifyUdkRecording(
                        mExtendedSmMgr.getLanguageModel(), lastRecordingData);
