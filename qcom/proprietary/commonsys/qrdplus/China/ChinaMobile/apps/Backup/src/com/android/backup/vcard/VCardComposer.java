...
import com.android.backup.ContactsContract.RawContactsEntity;
...
public class VCardComposer {
    ...
    static {
        ...
        sImMap.put(Im.PROTOCOL_QQ, VCardConstants.PROPERTY_X_QQ);
    ...
    public boolean init(final Uri contentUri, final String selection,
        ...
        if (contentUri == null) {
            Log.w(LOG_TAG, "The content Uri is null.");
            return false;
        }
        ...
        if (true || Contacts.CONTENT_URI.equals(contentUri) ||
    ...
    // zhl add for pim
    public boolean init(final Uri uri, final String selection, final String[] selectionArgs,
            boolean pimUse) {
        mPimUse = pimUse;
        return init(uri, selection, selectionArgs, null);
    }
    ...
    private String createOneEntryInternal(final String contactId,
        ...
        final VCardBuilder builder = new VCardBuilder(mVCardType, mPimUse);
