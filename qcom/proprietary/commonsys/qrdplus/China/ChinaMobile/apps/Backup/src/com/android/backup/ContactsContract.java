...
import com.qualcomm.qti.backup_wrapper.ContentResolverWrapper;
import com.qualcomm.qti.backup_wrapper.CursorEntityIteratorWrapper;
import com.qualcomm.qti.backup_wrapper.IContentProviderWrapper;
 ...
 * </p>
 * <ul>
 * <li>A row in the {@link Data} table can store any kind of personal data, such
 ...
 * kinds, but any application can add its own data kinds.</li>
 * <li>A row in the {@link RawContacts} table represents a set of data
 * describing a person and associated with a single account (for example, one of
 * the user's Gmail accounts).</li>
 * <li>A row in the {@link Contacts} table represents an aggregate of one or
 * more RawContacts presumably describing the same person. When data in or
 * associated with the RawContacts table is changed, the affected aggregate
 * contacts are updated as necessary.</li>
 * </ul>
 * <p>
 ...
 * <ul>
 * <li>
 * {@link Groups}, which contains information about raw contact groups such
 * as Gmail contact groups. The current API does not support the notion of
 * groups spanning multiple accounts.</li>
 * <li>
 ...
 * disaggregation of raw contacts</li>
 * <li>
 * {@link Settings}, which contains visibility and sync settings for
 * accounts and groups.</li>
 * <li>
 * {@link SyncState}, which contains free-form data maintained on behalf of
 * sync adapters</li>
 * <li>
...
public final class ContactsContract {
     ...
     * is false. If true {@link RawContacts#DIRTY} is not automatically set and
     * the "syncToNetwork" parameter is set to false when calling
     * {@link ContentResolver#notifyChange(android.net.Uri, android.database.ContentObserver, boolean)}
     * . This prevents an unnecessary extra synchronization, see the discussion
     * of the delete operation in {@link RawContacts}.
     */
    public static final String CALLER_IS_SYNCADAPTER = "caller_is_syncadapter";

    /**
     * A query parameter key used to specify the package that is requesting a
     * query. This is used for restricting data based on package name.
     *
     * @hide
     */
    ...
    public static final class Preferences {
         ...
         * android.provider.Settings} provider that stores the preferred sorting
         * order for contacts (by given name vs. by family name).
         *
         * @hide
         */
        ...
        /**
         * The value for the SORT_ORDER key corresponding to sorting by given
         * name first.
         *
         * @hide
         */
        ...
        /**
         * The value for the SORT_ORDER key corresponding to sorting by family
         * name first.
         *
         * @hide
         */
        ...
        /**
         * A key in the {@link android.provider.Settings
         * android.provider.Settings} provider that stores the preferred display
         * order for contacts (given name first vs. family name first).
         *
         * @hide
         */
        ...
        /**
         * The value for the DISPLAY_ORDER key corresponding to showing the
         * given name first.
         *
         * @hide
         */
    ...
    public static final int DEVICE_TYPE_UIM = 1;
    public static final int DEVICE_TYPE_SIM = 2;
    ...
    public static final int MEMORY_TYPE_USIM = 3; // chenxiang 20110127

    // memory max count
    public static final int MAX_COUNT_PHONE = 2000;
    public static final int MAX_COUNT_UIM = 250;
    public static final int MAX_COUNT_SIM = 250;

    private static final String PHONEBOOK_DATA_DIR = "/data/data";

    public static Boolean hasEnoughSpace()
    {
        File path = new File(PHONEBOOK_DATA_DIR);
    ...
    public static int enableTransactionLock(String strPackageName, ContentResolver cr)
    {
       // IContentProvider provider = cr.acquireProvider(Contacts.CONTENT_URI);
        ContentResolverWrapper wrapper = new ContentResolverWrapper(cr);
        IContentProviderWrapper provider = null;
        try {
            provider = wrapper.acquireProvider(Contacts.CONTENT_URI);
        } catch (WrapperNotSupportException wrapperE) {
            Log.e(TAG,"acquireProvider: catch an exception ", wrapperE);
            return -1;
        }
        ...
        try {
            provider.call(strPackageName, "enableTransactionLock", null, null);
            return 1;
           ...
           // cr.releaseProvider(provider);
            try{
                wrapper.releaseProvider(provider);
            } catch (WrapperNotSupportException wrapperE) {
                Log.e(TAG,"releaseProvider: catch an exception ", wrapperE);
            }
        }
    }

    // huangjiufa add for bulk operation
    public static int disableTransactionLock(String strPackageName, ContentResolver cr)
    {
      //  IContentProvider provider = cr.acquireProvider(Contacts.CONTENT_URI);
        ContentResolverWrapper wrapper = new ContentResolverWrapper(cr);
        IContentProviderWrapper provider = null;
        ...
        try {
            provider.call(strPackageName, "disableTransactionLock", null, null);
            return 1;
        } catch (RemoteException e) {
            return -1;
        } finally {
    ...
    protected interface SyncColumns extends BaseSyncColumns {
        /**
         * The name of the account instance to which this row belongs, which
         * when paired with {@link #ACCOUNT_TYPE} identifies a specific account.
         * <P>
         * Type: TEXT
         * </P>
         */
    ...
    protected interface ContactOptionsColumns {
         ...
         * missing, the default ringtone is used.
         * <P>
        ...
        // BEGIN huangjiufa add for record 20100505
        /**
         * <P>
         * location,for PIM sync,tabel:Recordsync
         * </P>
         * <P>
         * nlocation equals "primary_location".
         * </P>
         * <P>
        ...
        /**
         * The person's memory_type, include phone/UIM/SIM etc.
         * <P>
         * Type: TEXT
         * </P>
         */
        ...
        /**
         * The person's default number type.
         * <P>
         * Type: TEXT
         * </P>
         */
     ...
     * properties of the contact, as opposed to the user-specified options found
     * in {@link ContactOptionsColumns}.
     *
     * @see Contacts
     * @see ContactsContract.Data
     * @see PhoneLookup
    ...
    protected interface ContactsColumns {
        ...
        /**
         * Reference to the row in the RawContacts table holding the contact
         * name.
         * <P>
    ...
    protected interface ContactStatusColumns {
        /**
         * Contact presence status. See {@link StatusUpdates} for individual
         * status definitions.
         * <p>
         * Type: NUMBER
         * </p>
    ...
    /**
     * Constants for various styles of capturing the pronunciation of a person's
     * name.
     *
     * @hide
     */
    public interface PhoneticNameStyle {
        ...
        /**
         * Pinyin is a phonetic method of entering Chinese characters. Typically
         * not explicitly shown in UIs, but used for searches and sorting.
         */
        public static final int PINYIN = 3;

        /**
         * Hiragana and Katakana are two common styles of writing out the
         * pronunciation of a Japanese names.
         */
        public static final int JAPANESE = 4;
    ...
    /**
     * Types of data used to produce the display name for a contact. Listed in
     * the order of increasing priority.
     *
     * @hide
     */
    ...
    protected interface ContactNameColumns {
        ...
        /**
         * The kind of data that is used as the display name for the contact,
         * such as structured name or email address. See DisplayNameSources.
        ...
        /**
         * <p>
         * The standard text shown as the contact's display name, based on the
         * best available information for the contact (for example, it might be
         * the email address if the name is not available). The information
         * actually used to compute the name is stored in
         * {@link #DISPLAY_NAME_SOURCE}.
         * </p>
         * <p>
         * A contacts provider is free to choose whatever representation makes
         * most sense for its target market. For example in the default Android
         * Open Source Project implementation, if the display name is based on
         * the structured name and the structured name follows the Western
         * full-name style, then this field contains the "given name first"
        ...
        /**
         * <p>
         * An alternative representation of the display name, such as
         * "family name first" instead of "given name first" for Western names.
         * If an alternative is not available, the values should be the same as
         * {@link #DISPLAY_NAME_PRIMARY}.
         * </p>
         * <p>
         * A contacts provider is free to provide alternatives as necessary for
         * its target market. For example the default Android Open Source
         * Project contacts provider currently provides an alternative in a
         * single case: if the display name is based on the structured name and
         * the structured name follows the Western full name style, then the
         * field contains the "family name first" version of the full name.
        ...
        /**
         * The phonetic alphabet used to represent the {@link #PHONETIC_NAME}.
         * See PhoneticNameStyle. TODO: convert PhoneticNameStyle to a link
         * after it is un-hidden
         */
         ...
         * </p>
         * <p>
         * The value may be set manually by the user. This capability is is of
         ...
         * name's Pinyin spelling, and for Japanese names it is the Hiragana
         * version of the phonetic name.
         */
        public static final String SORT_KEY_PRIMARY = "sort_key";

        /**
         * Sort key based on the alternative representation of the full name,
         * {@link #DISPLAY_NAME_ALTERNATIVE}. Thus for Western names, it is the
         * one using the "family name first" format.
         */
    ...
    public final static class ContactCounts {
        ...
        /**
         * The array of group counts for the corresponding group. Contains the
         * same number of elements as the EXTRA_ADDRESS_BOOK_INDEX_TITLES array.
         * <p>
         * TYPE: int[]
         * </p>
         *
     ...
     * of raw contacts representing the same person. <h3>Operations</h3>
     * <dl>
     * <dt><b>Insert</b></dt>
     ...
     * {@link ContactsContract.Data} table. The result will contain contact ID,
     * name etc.
     * </ul>
     * </dd>
     * </dl>
     ...
     * <td>read-only</td>
     * <td>The ID of the raw contact that contributes the display name to the
     * aggregate contact. During aggregation one of the constituent raw contacts
     * is chosen using a heuristic: a longer name or a name with more diacritic
     * marks or more upper case characters is chosen.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>DISPLAY_NAME_PRIMARY</td>
     * <td>read-only</td>
     * <td>The display name for the contact. It is the display name contributed
     * by the raw contact referred to by the NAME_RAW_CONTACT_ID column.</td>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #PHOTO_ID}</td>
     * <td>read-only</td>
     * <td>Reference to the row in the {@link ContactsContract.Data} table
     * holding the photo. That row has the mime type
    ...
    public static class Contacts implements BaseColumns, ContactsColumns,
         ...
         * should always be followed by a "/" and the contact's
         * {@link #LOOKUP_KEY}. It can optionally also have a "/" and last known
         * contact ID appended after that. This "complete" format is an
         ...
         * encoded and joined with the colon (":") seperator. The resulting
         * string has to be encoded again. Provides {@link OpenableColumns}
         * columns when queried, or returns the referenced contact formatted as
         * a vCard when opened through
         * {@link ContentResolver#openAssetFileDescriptor(Uri, String)}. This is
         * private API because we do not have a well-defined way to specify
         * several entities yet. The format of this Uri might change in the
         * future or the Uri might be completely removed.
         *
         * @hide
         */
         ...
         * The content:// style URI for this table
         */
        public static final Uri RECORDS_CONTENT_URI = Uri
                .withAppendedPath(AUTHORITY_URI, "records");
         ...
         * <p>
         * As long as the contact's row ID remains the same, this URI is
         * equivalent to {@link #RECORDS_CONTENT_URI}. If the contact's row ID
         * changes as a result of a sync or aggregation, this URI will look up
         * the contact using indirect information (sync IDs or constituent raw
         * contacts).
         * <p>
         * Lookup key should be appended unencoded - it is stored in the encoded
         * form, ready for use in a URI.
         */
        public static final Uri RECORDS_CONTENT_LOOKUP_URI = Uri.withAppendedPath(
                RECORDS_CONTENT_URI,
                "lookup");
         ...
         * {@link ContentResolver#openAssetFileDescriptor(Uri, String)}.
         */
        public static final Uri RECORDS_CONTENT_VCARD_URI = Uri.withAppendedPath(
                RECORDS_CONTENT_URI,
                "as_vcard");
        ...
        public static Uri lookupContact(ContentResolver resolver, Uri lookupUri) {
            ...
            Cursor c = resolver.query(lookupUri, new String[] {
                Contacts._ID
            }, null, null, null);
            if (c == null) {
                return null;
        ...
        public static void markAsContacted(ContentResolver resolver, long contactId) {
            ...
            // TIMES_CONTACTED will be incremented when LAST_TIME_CONTACTED is
            // modified.
        ...
        /**
         * The content:// style URI used for "type-to-filter" functionality on
         * the {@link #CONTENT_URI} URI. The filter string will be used to match
         * various parts of the contact name. The filter argument should be
         ...
         * {@link ContactsContract.Data}, filtered to include only starred
        ...
        /**
         * The content:// style URI used for "type-to-filter" functionality on
         * the {@link #CONTENT_STREQUENT_URI} URI. The filter string will be
         * used to match various parts of the contact name. The filter argument
        ...
        public static final java.lang.String CONTENT_VCARD_ITEM_TYPE = "vnd.android.cursor.item/text/x-vCard";
        public static final java.lang.String CONTENT_PHONE_EMAIL_ITEM_TYPE = "vnd.android.cursor.item/phone-email";
         ...
         * passed as an additional path segment after this URI.
         */
        public static final Uri RECORDS_CONTENT_FILTER_URI = Uri.withAppendedPath(
                RECORDS_CONTENT_URI, "filter");
         ...
         * contacts and the most frequently contacted contacts.
         */
        public static final Uri RECORDS_CONTENT_STREQUENT_URI = Uri.withAppendedPath(
                RECORDS_CONTENT_URI, "strequent");

        /**
         * The content:// style URI used for "type-to-filter" functionality on
         * the {@link #RECORDS_CONTENT_STREQUENT_URI} URI. The filter string
         * will be used to match various parts of the contact name. The filter
         * argument should be passed as an additional path segment after this
         * URI.
         */
        public static final Uri RECORDS_CONTENT_STREQUENT_FILTER_URI = Uri.withAppendedPath(
                RECORDS_CONTENT_STREQUENT_URI, "filter");

        public static final Uri RECORDS_CONTENT_GROUP_URI = Uri.withAppendedPath(
                RECORDS_CONTENT_URI, "group");

        /**
         * The MIME type of {@link #RECORDS_CONTENT_TYPE} providing a directory
         * of people.
         */
        public static final String RECORDS_CONTENT_TYPE = "vnd.android.cursor.dir/record";

        /**
         * The MIME type of a {@link #RECORDS_CONTENT_URI} subdirectory of a
         * single person.
         */
        public static final String RECORDS_CONTENT_ITEM_TYPE = "vnd.android.cursor.item/record";
         ...
         * constituent raw contact {@link ContactsContract.Data} rows.
         */
        ...
        public static final class AggregationSuggestions implements BaseColumns, ContactsColumns {
            ...
            /**
             * The directory twig for this sub-table. The URI can be followed by
             * an optional type-to-filter, similar to
        ...
        public static final class Photo implements BaseColumns, DataColumns {
            ...
            /**
             * Thumbnail photo of the raw contact. This is the raw bytes of an
             * image that could be inflated using
    ...
    protected interface RawContactsColumns {
        ...
        /**
         * Flag indicating that this {@link RawContacts} entry and its children
         * have been restricted to specific platform apps.
         * <P>
         * Type: INTEGER (boolean)
         * </P>
         *
         ...
         * called on a raw contact, it is marked for deletion and removed from
         * its aggregate contact. The sync adaptor deletes the raw contact on
         * the server and then calls ContactResolver.delete once more, this time
         * passing the {@link ContactsContract#CALLER_IS_SYNCADAPTER} query
         * parameter to finalize the data removal.
         * <P>
         * Type: INTEGER
         * </P>
         */
         ...
         * verified name, one of those verified names is chosen at random. If an
         * aggregated contact contains no verified names, the name is chosen
     ...
     * contact management apps are the primary consumers of this API. <h3>
     * Aggregation</h3>
     * <p>
     ...
     * aggregation is reflected in the {@link RawContacts} table by the change
     * of the {@link #CONTACT_ID} field, which is the reference to the aggregate
     * contact.
     * </p>
     * <p>
     * Changes to the structured name, organization, phone number, email
     * address, or nickname trigger a re-aggregation.
     * </p>
     * <p>
     ...
     * method is more traditional but less efficient. It should be used only if
     * no {@link Data} values are available at the time the raw contact is
     * created:
     *
     * <pre>
     * ContentValues values = new ContentValues();
     ...
     * </p>
     * <p>
     * Once {@link Data} values become available, insert those. For example,
     * here's how you would insert a name:
     *
     * <pre>
     * values.clear();
     ...
     * constituent data rows in a single database transaction and causes at most
     ...
     * <p>
     * Note the use of
     * {@link ContentProviderOperation.Builder#withValueBackReference(String, int)}
     * to refer to the as-yet-unknown index value of the raw contact inserted in
     * the first operation.
     * </p>
     * <dt><b>Update</b></dt>
     * <dd>
     * <p>
     * Raw contacts can be updated incrementally or in a batch. Batch mode
     * should be used whenever possible. The procedures and considerations are
     * analogous to those documented above for inserts.
     * </p>
     * </dd>
     * <dt><b>Delete</b></dt>
     * <dd>
     * <p>
     * When a raw contact is deleted, all of its Data rows as well as
     * StatusUpdates, AggregationExceptions, PhoneLookup rows are deleted
     * automatically. When all raw contacts associated with a {@link Contacts}
     * row are deleted, the {@link Contacts} row itself is also deleted
     * automatically.
     * </p>
     * <p>
     * The invocation of {@code resolver.delete(...)}, does not immediately
     * delete a raw contacts row. Instead, it sets the {@link #DELETED} flag on
     * the raw contact and removes the raw contact from its aggregate contact.
     ...
     * again and passing the {@link ContactsContract#CALLER_IS_SYNCADAPTER}
     * query parameter.
     * <p>
     * <p>
     ...
     * effectively invisible, because it will not be part of any aggregate
     * contact.</dd>
     * <dt><b>Query</b></dt>
     * <dd>
     * <p>
     ...
     * </p>
     * <p>
     * To find raw contacts within a specific account, you can either put the
     * account name and type in the selection or pass them as query parameters.
     ...
     * with it is by using the {@link Entity} directory. If the raw contact has
     * data rows, the Entity cursor will contain a row for each data row. If the
     * raw contact has no data rows, the cursor will still contain one row with
     * the raw contact-level information.
     *
     * <pre>
     ...
     * <td>{@link #_ID}</td>
     * <td>read-only</td>
     * <td>Row ID. Sync adapters should try to preserve row IDs during updates.
     * In other words, it is much better for a sync adapter to update a raw
     * contact rather than to delete and re-insert it.</td>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #CONTACT_ID}</td>
     * <td>read-only</td>
     * <td>The ID of the row in the {@link ContactsContract.Contacts} table that
     * this raw contact belongs to. Raw contacts are linked to contacts by the
     * aggregation process, which can be controlled by the
     * {@link #AGGREGATION_MODE} field and {@link AggregationExceptions}.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #AGGREGATION_MODE}</td>
     * <td>read/write</td>
     * <td>A mechanism that allows programmatic control of the aggregation
     * process. The allowed values are {@link #AGGREGATION_MODE_DEFAULT},
     * {@link #AGGREGATION_MODE_DISABLED} and
     * {@link #AGGREGATION_MODE_SUSPENDED}. See also
     * {@link AggregationExceptions}.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #DELETED}</td>
     ...
     * aggregate contact. The sync adaptor deletes the raw contact on the server
     * and then calls ContactResolver.delete once more, this time passing the
     * {@link ContactsContract#CALLER_IS_SYNCADAPTER} query parameter to
     * finalize the data removal.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #TIMES_CONTACTED}</td>
     ...
     * on the corresponding value of the aggregate contact, this field should be
     * set at the time the raw contact is inserted. After that, this value is
     * typically updated via {@link ContactsContract.Contacts#markAsContacted}.</td>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #LAST_TIME_CONTACTED}</td>
     * <td>read/write</td>
     * <td>The timestamp of the last time the contact was contacted. To have an
     * effect on the corresponding value of the aggregate contact, this field
     * should be set at the time the raw contact is inserted. After that, this
     * value is typically updated via
     ...
     * <td>read/write</td>
     * <td>An indicator for favorite contacts: '1' if favorite, '0' otherwise.
     * Changing this field immediately affects the corresponding aggregate
     * contact: if any raw contacts in that aggregate contact are starred, then
     * the contact itself is marked as starred.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>{@link #CUSTOM_RINGTONE}</td>
     * <td>read/write</td>
     * <td>A custom ringtone associated with a raw contact. Typically this is
     * the URI returned by an activity launched with the
     * {@link android.media.RingtoneManager#ACTION_RINGTONE_PICKER} intent. To
     * have an effect on the corresponding value of the aggregate contact, this
     * field should be set at the time the raw contact is inserted. To set a
     * custom ringtone on a contact, use the field
     * {@link ContactsContract.Contacts#CUSTOM_RINGTONE
     * Contacts.CUSTOM_RINGTONE} instead.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #SEND_TO_VOICEMAIL}</td>
     * <td>read/write</td>
     * <td>An indicator of whether calls from this raw contact should be
     * forwarded directly to voice mail ('1') or not ('0'). To have an effect on
     * the corresponding value of the aggregate contact, this field should be
     * set at the time the raw contact is inserted.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>{@link #ACCOUNT_NAME}</td>
     * <td>read/write-once</td>
     * <td>The name of the account instance to which this row belongs, which
     * when paired with {@link #ACCOUNT_TYPE} identifies a specific account. For
     * example, this will be the Gmail address if it is a Google account. It
     * should be set at the time the raw contact is inserted and never changed
     * afterwards.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     ...
     * <p>
     * The type of account to which this row belongs, which when paired with
     * {@link #ACCOUNT_NAME} identifies a specific account. It should be set at
     * the time the raw contact is inserted and never changed afterwards.
     * </p>
     * <p>
     * To ensure uniqueness, new account types should be chosen according to the
     * Java package naming convention. Thus a Google account is of type
     * "com.google".
     * </p>
     * </td>
     * </tr>
     ...
     * will have an account name and type, but no source id. This indicates to
     * the sync adapter that a new contact needs to be created server-side and
     * its ID stored in the corresponding SOURCE_ID field on the phone.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #VERSION}</td>
     ...
     * changes. This field can be used for optimistic locking of a raw contact.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #DIRTY}</td>
     ...
     * to be synchronized by its owning account. The value is set to "1"
     * automatically whenever the raw contact changes, unless the URI has the
     ...
     * unnecessary synchronization: user changes some data on the server, the
     * sync adapter updates the contact on the phone (without the
     * CALLER_IS_SYNCADAPTER flag) flag, which sets the DIRTY flag, which
     * triggers a sync to bring the changes to the server.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>{@link #SYNC1}</td>
     * <td>read/write</td>
     * <td>Generic column provided for arbitrary use by sync adapters. The
     * content provider stores this information on behalf of the sync adapter
     * but does not interpret it in any way.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>{@link #SYNC2}</td>
     * <td>read/write</td>
     * <td>Generic column for use by sync adapters.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>{@link #SYNC3}</td>
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns,
         ...
         * of raw contact rows matching the selection criteria.
         */
        public static final Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, "raw_contacts");

        /**
         * The MIME type of the results from {@link #CONTENT_URI} when a
         * specific ID value is not provided, and multiple raw contacts may be
         * returned.
         */
         ...
         * {@link #CONTENT_URI}, yielding a subdirectory of a single person.
         */
         ...
         * The content:// style URI for this table
         */
        public static final Uri RECORDS_CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI,
                "raw_records");

        /**
         * The MIME type of {@link #RECORDS_CONTENT_URI} providing a directory
         * of people.
         */
        public static final String RECORDS_CONTENT_TYPE = "vnd.android.cursor.dir/raw_record";

        /**
         * The MIME type of a {@link #RECORDS_CONTENT_URI} subdirectory of a
         * single person.
         */
        public static final String RECORDS_CONTENT_ITEM_TYPE = "vnd.android.cursor.item/raw_record";
        ...
        /**
         * Do not use. TODO: deprecate in favor of
         * {@link #AGGREGATION_MODE_DEFAULT}
         */
        public static final int AGGREGATION_MODE_IMMEDIATE = 1;

        /**
         * <p>
         * Aggregation mode: aggregation suspended temporarily, and is likely to
         * be resumed later. Changes to the raw contact will update the
         * associated aggregate contact but will not result in any change in how
         * the contact is aggregated. Similar to
         * {@link #AGGREGATION_MODE_DISABLED}, but maintains a link to the
         * corresponding {@link Contacts} aggregate.
         * </p>
         * <p>
         * This can be used to postpone aggregation until after a series of
         * updates, for better performance and/or user experience.
         * </p>
         * <p>
         * Note that changing {@link #AGGREGATION_MODE} from
         * {@link #AGGREGATION_MODE_SUSPENDED} to
         * {@link #AGGREGATION_MODE_DEFAULT} does not trigger an aggregation
         * pass, but any subsequent change to the raw contact's data will.
         * </p>
         */
        ...
        /**
         * <p>
         * Aggregation mode: never aggregate this raw contact. The raw contact
         * will not have a corresponding {@link Contacts} aggregate and
         * therefore will not be included in {@link Contacts} query results.
         * </p>
         * <p>
         * For example, this mode can be used for a raw contact that is marked
         * for deletion while waiting for the deletion to occur on the server
         * side.
         * </p>
         *
         ...
         * style {@link Uri} for the parent
         * {@link android.provider.ContactsContract.Contacts} entry of the given
         * {@link RawContacts} entry.
         */
        public static Uri getContactLookupUri(ContentResolver resolver, Uri rawContactUri) {
            // TODO: use a lighter query by joining rawcontacts with contacts in
            // provider
         ...
         * {@link Data#CONTENT_DIRECTORY} to the contact URI. TODO: deprecate in
         * favor of {@link RawContacts.Entity}.
         */
        public static final class Data implements BaseColumns, DataColumns {
            /**
             * no public constructor since this is a utility class
         ...
         * </p>
         * <p>
         * Entity has two ID fields: {@link #_ID} for the raw contact and
         * {@link #DATA_ID} for the data rows. Entity always contains at least
         * one row, even if there are no actual data rows. In this case the
         * {@link #DATA_ID} field will be null.
         * </p>
         * <p>
         * Entity reads all data for a raw contact in one transaction, to
        ...
        public static final class Entity implements BaseColumns, DataColumns {
            ...
            /**
             * The ID of the data column. The value will be null if this raw
        ...
        private static class EntityIteratorImpl extends CursorEntityIteratorWrapper {
            ...
            public android.content.Entity getEntityAndIncrementCursor(Cursor cursor)
                ...
                // we expect the cursor is already at the row we need to read
                // from
    ...
    protected interface StatusColumns {
        ...
        /**
         * The resource ID of the label describing the source of the status
         * update, e.g. "Google Talk". This resource should be scoped by the
        ...
        /**
         * The resource ID of the icon for the source of the status update. This
         * resource should be scoped by the {@link #STATUS_RES_PACKAGE}.
         * <p>
         * Type: NUMBER
         * </p>
         */
        ...
        /**
         * An allowed value of {@link #CHAT_CAPABILITY}. Indicates that the
         * contact's device can display a video feed.
         *
         * @hide
         */
        ...
        /**
         * An allowed value of {@link #CHAT_CAPABILITY}. Indicates audio-chat
         * capability.
         *
         * @hide
         */
        ...
        /**
         * An allowed value of {@link #CHAT_CAPABILITY}. Indicates that the
         * contact's device has a camera that can be used for video chat (e.g. a
    ...
    protected interface DataColumns {
         ...
         * column is guaranteed to not change without the version going up. This
        ...
        /**
         * Generic data column, the meaning is {@link #MIMETYPE} specific. By
         * convention, this field is used to store BLOBs (binary data).
         */
    ...
    /**
     * Combines all columns returned by {@link ContactsContract.Data} table
     * queries.
     *
     * @see ContactsContract.Data
     */
     ...
     * piece of contact information (such as a phone number) and its associated
     * metadata (such as whether it is a work or home number).
     * </p>
     * <h3>Data kinds</h3>
     * <p>
     * Data is a generic table that can hold any kind of contact data. The kind
     * of data stored in a given row is specified by the row's {@link #MIMETYPE}
     * value, which determines the meaning of the generic columns {@link #DATA1}
     * through {@link #DATA15}. For example, if the data kind is
     * {@link CommonDataKinds.Phone Phone.CONTENT_ITEM_TYPE}, then the column
     * {@link #DATA1} stores the phone number, but if the data kind is
     * {@link CommonDataKinds.Email Email.CONTENT_ITEM_TYPE}, then
     * {@link #DATA1} stores the email address. Sync adapters and applications
     ...
     * convenience, these classes define data kind specific aliases for DATA1
     * etc. For example, {@link CommonDataKinds.Phone Phone.NUMBER} is the same
     * as {@link ContactsContract.Data Data.DATA1}.
     * </p>
     * <p>
     * {@link #DATA1} is an indexed column and should be used for the data
     * element that is expected to be most frequently used in query selections.
     * For example, in the case of a row representing email addresses
     * {@link #DATA1} should probably be used for the email address itself,
     * while {@link #DATA2} etc can be used for auxiliary information like type
     * of email address.
     * <p>
     * <p>
     ...
     * </p>
     * <p>
     * The sync adapter for a given account type must correctly handle every
     * data type used in the corresponding raw contacts. Otherwise it could
     * result in lost or corrupted data.
     * </p>
     * <p>
     * Similarly, you should refrain from introducing new kinds of data for an
     * other party's account types. For example, if you add a data row for
     ...
     * <dd>
     * <p>
     * Just as with insert, update can be done incrementally or as a batch, the
     ...
     * {@link ContentResolver#delete} method or using a
     ...
     * <dd>Most sync adapters will want to read all data rows for a raw contact
     * along with the raw contact itself. For that you should use the
     * {@link RawContactsEntity}. See also {@link RawContacts}.</dd>
     * </dl>
     * </p> </dd> </dl> <h2>Columns</h2>
     * <p>
     * Many columns are available via a {@link Data#CONTENT_URI} query. For best
     * performance you should explicitly specify a projection to only those
     ...
     * In other words, it would be a bad idea to delete and reinsert a data row.
     * A sync adapter should always do an update instead.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     * <td>{@link #MIMETYPE}</td>
     ...
     * MIME types are:
     * <ul>
     * <li>{@link CommonDataKinds.StructuredName
     * StructuredName.CONTENT_ITEM_TYPE}</li>
     ...
     * <li>{@link CommonDataKinds.StructuredPostal
     * StructuredPostal.CONTENT_ITEM_TYPE}</li>
     * <li>{@link CommonDataKinds.GroupMembership
     * GroupMembership.CONTENT_ITEM_TYPE}</li>
     ...
     * <td>read/write-once</td>
     * <td>The id of the row in the {@link RawContacts} table that this data
     * belongs to.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     ...
     * <td>read/write</td>
     * <td>Whether this is the primary entry of its kind for the raw contact it
     * belongs to. "1" if true, "0" if false.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     ...
     * contact it belongs to. Any data record that is "super primary" must also
     * be "primary". For example, the super-primary entry may be interpreted as
     * the default contact value of its kind (for example, the default phone
     * number to use for the contact).</td>
     * </tr>
     * <tr>
     * <td>int</td>
     * <td>{@link #DATA_VERSION}</td>
     * <td>read-only</td>
     * <td>The version of this data record. Whenever the data row changes the
     * version goes up. This value is monotonically increasing.</td>
     * </tr>
     * <tr>
     * <td>Any type</td>
     * <td>
     ...
     * preserve them. Sync adapters themselves should not use such columns
     * either, but should instead use {@link #SYNC1}-{@link #SYNC4}.
     * </p>
     * </td>
     * </tr>
     * <tr>
     ...
     * may store the image URL in SYNC1, a status (not loaded, loading, loaded,
     * error) in SYNC2, server-side version number in SYNC3 and error code in
     * SYNC4.</td>
     * </tr>
     * </table>
     * <p>
     * Some columns from the most recent associated status update are also
     * available through an implicit join.
     * </p>
     * <table class="jd-sumtable">
     * <tr>
     ...
     * The provider may choose not to store this value in persistent storage.
     * The expectation is that presence status will be updated on a regular
     * basic.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     ...
     * <td>read-only</td>
     * <td>The resource ID of the label describing the source of status update
     * linked to this data row. This resource is scoped by the
     ...
     * <td>read-only</td>
     * <td>The resource ID of the icon for the source of the status update
     * linked to this data row. This resource is scoped by the
     * {@link #STATUS_RES_PACKAGE}.</td>
     * </tr>
     * </table>
     * <p>
     * Some columns from the associated raw contact are also available through
     * an implicit join. The other columns are excluded as uninteresting in this
     * context.
     * </p>
     * <table class="jd-sumtable">
     * <tr>
     ...
     * <td style="width: 5em;">read-only</td>
     * <td>The id of the row in the {@link Contacts} table that this data
     * belongs to.</td>
     * </tr>
     * <tr>
     * <td>int</td>
     ...
     * {@link ContactsContract.Contacts} is available via the implicit join to
     * the {@link RawContacts} table, see above. The remaining columns from this
     * table are also available, through an implicit join. This facilitates
    ...
    public final static class Data implements DataColumnsWithJoins {
        ...
        /**
         * <p>
         * If {@link #FOR_EXPORT_ONLY} is explicitly set to "1", returned Cursor
         * toward Data.CONTENT_URI contains only exportable data.
         * </p>
         * <p>
         * This flag is useful (currently) only for vCard exporter in Contacts
         * app, which needs to exclude "un-exportable" data from available data
         * to export, while Contacts app itself has priviledge to access all
         * data including "un-exportable" ones and providers return all of them
         * regardless of the callers' intention.
         * </p>
         * <p>
         * Type: INTEGER
         * </p>
         *
         * @hide Maybe available only in Eclair and not really ready for public
         *       use. TODO: remove, or implement this feature completely. As of
         *       now (Eclair), we only use this flag in queryEntities(), not
         *       query().
         */
         ...
         * style {@link Uri} for the parent
         * {@link android.provider.ContactsContract.Contacts} entry of the given
         * {@link ContactsContract.Data} entry.
         * </p>
         * <p>
     ...
     * an outer join of the raw_contacts table with the data table. It is a
     * strictly read-only table.
     * </p>
     * <p>
     ...
     * </pre>
     *
     * <h3>Columns</h3> RawContactsEntity has a combination of RawContact and
     * Data columns.
     * <table class="jd-sumtable">
     * <tr>
     * <th colspan='4'>RawContacts</th>
    ...
    public final static class RawContactsEntity
         ...
         * The content:// style URI for this table
         */
        public static final Uri RECORDS_CONTENT_URI =
                Uri.withAppendedPath(AUTHORITY_URI, "raw_record_entities");

        /**
         * The MIME type of {@link #RECORDS_CONTENT_URI} providing a directory
         * of raw record entities.
         */
        public static final String RECORDS_CONTENT_TYPE = "vnd.android.cursor.dir/raw_record_entity";

        /**
         * If {@link #FOR_EXPORT_ONLY} is explicitly set to "1", returned Cursor
         * toward Data.CONTENT_URI contains only exportable data. This flag is
         * useful (currently) only for vCard exporter in Contacts app, which
         * needs to exclude "un-exportable" data from available data to export,
         * while Contacts app itself has priviledge to access all data including
         * "un-expotable" ones and providers return all of them regardless of
         * the callers' intention.
         * <P>
         * Type: INTEGER
         * </p>
         *
        ...
        /**
         * The ID of the data column. The value will be null if this raw contact
         * has no data rows.
         * <P>
         * Type: INTEGER
         * </P>
     ...
     * <td>{@link #LABEL}</td>
     * <td>read-only</td>
     * <td>Custom label for the phone number. See {@link CommonDataKinds.Phone}.
     * </td>
     * </tr>
     * </table>
     * <p>
    ...
    public static final class PhoneLookup implements BaseColumns, PhoneLookupColumns,
        ...
        /**
         * The MIME type of {@link #CONTENT_FILTER_URI} providing a directory of
         * phone lookup rows.
         *
         * @hide
         */
    ...
    /**
     * Additional data mixed in with {@link StatusColumns} to link back to
     * specific {@link ContactsContract.Data#_ID} entries.
     *
     * @see StatusUpdates
     */
    protected interface PresenceColumns {
        ...
        /**
         * See {@link CommonDataKinds.Im} for a list of defined protocol
         * constants.
         * <p>
         * Type: NUMBER
         * </p>
         ...
         * {@link #PROTOCOL} value
         * {@link ContactsContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}. Should
         * be null or omitted if {@link #PROTOCOL} value is not
    ...
    /**
     * <p>
     * A status update is linked to a {@link ContactsContract.Data} row and
     * captures the user's latest status update via the corresponding source,
     * e.g. "Having lunch" via "Google Talk".
     * </p>
     * <p>
     * There are two ways a status update can be inserted: by explicitly linking
     * it to a Data row using {@link #DATA_ID} or indirectly linking it to a
     * data row using a combination of {@link #PROTOCOL} (or
     * {@link #CUSTOM_PROTOCOL}) and {@link #IM_HANDLE}. There is no difference
     * between insert and update, you can use either.
     * </p>
     * <p>
     * You cannot use {@link ContentResolver#update} to change a status, but
     * {@link ContentResolver#insert} will replace the latests status if it
     * already exists.
     * </p>
     * <p>
     * Use {@link ContentResolver#bulkInsert(Uri, ContentValues[])} to
     * insert/update statuses for multiple contacts at once.
     * </p>
     * <h3>Columns</h3>
     * <table class="jd-sumtable">
     * <tr>
     ...
     * <td>{@link #DATA_ID}</td>
     * <td>read/write</td>
     * <td>Reference to the {@link Data#_ID} entry that owns this presence. If
     * this field is <i>not</i> specified, the provider will attempt to find a
     * data row that matches the {@link #PROTOCOL} (or {@link #CUSTOM_PROTOCOL})
     * and {@link #IM_HANDLE} columns.</td>
     * </tr>
     * <tr>
     * <td>long</td>
     * <td>{@link #PROTOCOL}</td>
     * <td>read/write</td>
     * <td>See {@link CommonDataKinds.Im} for a list of defined protocol
     * constants.</td>
     * </tr>
     * <tr>
     * <td>String</td>
     ...
     * <td>read/write</td>
     * <td>Name of the custom protocol. Should be supplied along with the
     * {@link #PROTOCOL} value
     * {@link ContactsContract.CommonDataKinds.Im#PROTOCOL_CUSTOM}. Should be
     * null or omitted if {@link #PROTOCOL} value is not
     ...
     * <td>{@link #STATUS_TIMESTAMP}</td>
     * <td>read/write</td>
     * <td>The absolute time in milliseconds when the status was entered by the
     * user. If this value is not provided, the provider will follow this logic:
     * if there was no prior status update, the value will be left as null. If
     * there was a prior status update, the provider will default this field to
     * the current time.</td>
     * </tr>
     * <tr>
     * <td>String</td>
    ...
    public static class StatusUpdates implements StatusColumns, PresenceColumns {
        ...
        /**
         * Returns the precedence of the status code the higher number being the
         * higher precedence.
         *
        ...
        public static final int getPresencePrecedence(int status) {
            // Keep this function here incase we want to enforce a different
            // precedence than the
    ...
    /**
     * Additional columns returned by the {@link Contacts#CONTENT_FILTER_URI}
     * providing the explanation of why the filter matched the contact.
     * Specifically, they contain the data type and element that was used for
     * matching.
     * <p>
    ...
    public static class SearchSnippetColumns {
        ...
        /**
         * The {@link Data#DATA1} field of the data row that was matched by the
         * filter.
         *
         * @hide
         */
        ...
        /**
         * The {@link Data#DATA2} field of the data row that was matched by the
         * filter.
         *
         * @hide
         */
        ...
        /**
         * The {@link Data#DATA3} field of the data row that was matched by the
         * filter.
         *
         * @hide
         */
        ...
        /**
         * The {@link Data#DATA4} field of the data row that was matched by the
         * filter.
         *
         * @hide
         */
     ...
     * {@link ContactsContract.Data} table.
     */
    public static final class CommonDataKinds {
         ...
         * columns defined for {@link ContactsContract.Data} as well as the
         * following aliases. <h2>Column aliases</h2>
         * <table class="jd-sumtable">
         * <tr>
         * <th>Type</th>
         * <th>Alias</th>
         * <th colspan='2'>Data column</th>
         * </tr>
         * <tr>
         * <td>String</td>
         * <td>{@link #DISPLAY_NAME}</td>
         ...
         * <td>{@link #DATA7}</td>
         * <td>Used for phonetic spelling of the name, e.g. Pinyin, Katakana,
         * Hiragana</td>
         * </tr>
         * <tr>
         * <td>String</td>
        ...
        public static final class StructuredName implements DataColumnsWithJoins {
            ...
            /**
             * The style used for combining given/middle/family name into a full
             * name. See {@link ContactsContract.FullNameStyle}.
             *
             * @hide
             */
        ...
        /**
         * <p>
         * A data kind representing the contact's nickname. For example, for Bob
         * Parr ("Mr. Incredible"):
         *
         * <pre>
         * ArrayList&lt;ContentProviderOperation&gt; ops = Lists.newArrayList();
        ...
        public static final class Phone implements DataColumnsWithJoins, CommonColumns {
            ...
            /**
             * The content:// style URL for phone lookup using a filter. The
             * filter returns records of MIME type {@link #CONTENT_ITEM_TYPE}.
             * The filter is applied to display names as well as phone numbers.
             * The filter argument should be passed as an additional path
            ...
            /**
             * @deprecated use
             *             {@link #getTypeLabel(Resources, int, CharSequence)}
             *             instead.
             * @hide
             */
            @Deprecated
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case TYPE_HOME:
                        return ResourcesWrapper.string.phoneTypeHome;
                    case TYPE_MOBILE:
                        return ResourcesWrapper.string.phoneTypeMobile;
                    case TYPE_WORK:
                        return ResourcesWrapper.string.phoneTypeWork;
                    case TYPE_FAX_WORK:
                        return ResourcesWrapper.string.phoneTypeFaxWork;
                    case TYPE_FAX_HOME:
                        return ResourcesWrapper.string.phoneTypeFaxHome;
                    case TYPE_PAGER:
                        return ResourcesWrapper.string.phoneTypePager;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.phoneTypeOther;
                    case TYPE_CALLBACK:
                        return ResourcesWrapper.string.phoneTypeCallback;
                    case TYPE_CAR:
                        return ResourcesWrapper.string.phoneTypeCar;
                    case TYPE_COMPANY_MAIN:
                        return ResourcesWrapper.string.phoneTypeCompanyMain;
                    case TYPE_ISDN:
                        return ResourcesWrapper.string.phoneTypeIsdn;
                    case TYPE_MAIN:
                        return ResourcesWrapper.string.phoneTypeMain;
                    case TYPE_OTHER_FAX:
                        return ResourcesWrapper.string.phoneTypeOtherFax;
                    case TYPE_RADIO:
                        return ResourcesWrapper.string.phoneTypeRadio;
                    case TYPE_TELEX:
                        return ResourcesWrapper.string.phoneTypeTelex;
                    case TYPE_TTY_TDD:
                        return ResourcesWrapper.string.phoneTypeTtyTdd;
                    case TYPE_WORK_MOBILE:
                        return ResourcesWrapper.string.phoneTypeWorkMobile;
                    case TYPE_WORK_PAGER:
                        return ResourcesWrapper.string.phoneTypeWorkPager;
                    case TYPE_ASSISTANT:
                        return ResourcesWrapper.string.phoneTypeAssistant;
                    case TYPE_MMS:
                        return ResourcesWrapper.string.phoneTypeMms;
                    default:
                        return ResourcesWrapper.string.phoneTypeCustom;
                }
            }
        ...
        public static final class Email_Phone implements DataColumnsWithJoins, CommonColumns {
            /**
             * This utility class cannot be instantiated
             */
            private Email_Phone() {
            ...
            /** MIME type used when storing this in data table. */
            public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/email_phone";

            /**
             * The MIME type of {@link #CONTENT_URI} providing a directory of
             * email addresses.
             */
            public static final String CONTENT_TYPE = "vnd.android.cursor.dir/email_phone";
            ...
            /**
             * <p>
             * The content:// style URL for looking up data rows by email
             * address. The lookup argument, an email address, should be passed
             ...
             *
             * <pre>
             * Uri uri = Uri.withAppendedPath(Email_Phone.CONTENT_LOOKUP_URI, Uri.encode(email));
             * Cursor c = getContentResolver().query(uri,
             *         new String[] {
             *                 Email_Phone.CONTACT_ID, Email_Phone.DISPLAY_NAME, Email_Phone.DATA
             *         },
             *         null, null, null);
             * </pre>
             *
            ...
            /**
             * <p>
             * The content:// style URL for email lookup using a filter. The
             * filter returns records of MIME type {@link #CONTENT_ITEM_TYPE}.
             * The filter is applied to display names as well as email
             * addresses. The filter argument should be passed as an additional
             * path segment after this URI.
             * </p>
             * <p>
             ...
             *
             * <pre>
             * Uri uri = Uri.withAppendedPath(Email_Phone.CONTENT_LOOKUP_URI, Uri.encode(&quot;bob&quot;));
             * Cursor c = getContentResolver().query(uri,
             *         new String[] {
             *                 Email_Phone.DISPLAY_NAME, Email_Phone.DATA
             *         },
             *         null, null, null);
             * </pre>
             *
        ...
        public static final class Email implements DataColumnsWithJoins, CommonColumns {
             ...
             * Cursor c = getContentResolver().query(uri,
             *         new String[] {
             *                 Email.CONTACT_ID, Email.DISPLAY_NAME, Email.DATA
             *         },
             *         null, null, null);
             * </pre>
             *
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case TYPE_HOME:
                        return ResourcesWrapper.string.emailTypeHome;
                    case TYPE_WORK:
                        return ResourcesWrapper.string.emailTypeWork;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.emailTypeOther;
                    case TYPE_MOBILE:
                        return ResourcesWrapper.string.emailTypeMobile;
                    default:
                        return ResourcesWrapper.string.emailTypeCustom;
                }
            }
        ...
        public static final class StructuredPostal implements DataColumnsWithJoins, CommonColumns {
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case TYPE_HOME:
                        return ResourcesWrapper.string.postalTypeHome;
                    case TYPE_WORK:
                        return ResourcesWrapper.string.postalTypeWork;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.postalTypeOther;
                    default:
                        return ResourcesWrapper.string.postalTypeCustom;
                }
            }
        ...
        public static final class Im implements DataColumnsWithJoins, CommonColumns {
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case TYPE_HOME:
                        return ResourcesWrapper.string.imTypeHome;
                    case TYPE_WORK:
                        return ResourcesWrapper.string.imTypeWork;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.imTypeOther;
                    default:
                        return ResourcesWrapper.string.imTypeCustom;
                }
            }
            ...
            public static final int getProtocolLabelResource(int type) {
                switch (type) {
                    case PROTOCOL_AIM:
                        return ResourcesWrapper.string.imProtocolAim;
                    case PROTOCOL_MSN:
                        return ResourcesWrapper.string.imProtocolMsn;
                    case PROTOCOL_YAHOO:
                        return ResourcesWrapper.string.imProtocolYahoo;
                    case PROTOCOL_SKYPE:
                        return ResourcesWrapper.string.imProtocolSkype;
                    case PROTOCOL_QQ:
                        return ResourcesWrapper.string.imProtocolQq;
                    case PROTOCOL_GOOGLE_TALK:
                        return ResourcesWrapper.string.imProtocolGoogleTalk;
                    case PROTOCOL_ICQ:
                        return ResourcesWrapper.string.imProtocolIcq;
                    case PROTOCOL_JABBER:
                        return ResourcesWrapper.string.imProtocolJabber;
                    case PROTOCOL_NETMEETING:
                        return ResourcesWrapper.string.imProtocolNetMeeting;
                    default:
                        return ResourcesWrapper.string.imProtocolCustom;
                }
            }
        ...
        public static final class Organization implements DataColumnsWithJoins, CommonColumns {
            ...
            /**
             * The alphabet used for capturing the phonetic name. See
             * {@link ContactsContract.PhoneticNameStyle}.
             *
             * @hide
             */
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case TYPE_WORK:
                        return ResourcesWrapper.string.orgTypeWork;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.orgTypeOther;
                    default:
                        return ResourcesWrapper.string.orgTypeCustom;
                }
            }
        ...
        public static final class Event implements DataColumnsWithJoins, CommonColumns {
            ...
            public static int getTypeResource(Integer type) {
                if (type == null) {
                    return ResourcesWrapper.string.eventTypeOther;
                }
                switch (type) {
                    case TYPE_ANNIVERSARY:
                        return ResourcesWrapper.string.eventTypeAnniversary;
                    case TYPE_BIRTHDAY:
                        return ResourcesWrapper.string.eventTypeBirthday;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.eventTypeOther;
                    default:
                        return ResourcesWrapper.string.eventTypeOther;
         ...
         * </p>
         * <p>
         * Some sync adapters will choose to download photos in a separate pass.
         * A common pattern is to use columns
         * {@link ContactsContract.Data#SYNC1} through
         * {@link ContactsContract.Data#SYNC4} to store temporary data, e.g. the
         * image URL or ID, state of download, server-side version of the image.
         * It is allowed for the {@link #PHOTO} to be null.
         * </p>
         * <p>
         * You can use all columns defined for {@link ContactsContract.Data} as
         * well as the following aliases.
         ...
         * </p>
         * <p>
         * If this field is specified, the provider will first try to look up a
         * group with this {@link Groups Groups.SOURCE_ID}. If such a group is
         * found, it will use the corresponding row id. If the group is not
         * found, it will create one.</td>
         * </tr>
         * </table>
         */
        public static final class GroupMembership implements DataColumnsWithJoins {
             ...
             * Exactly one of this or {@link #GROUP_SOURCE_ID} must be set when
             * inserting a row.
             * <P>
             * Type: INTEGER
             * </P>
        ...
        public static final class SipAddress implements DataColumnsWithJoins, CommonColumns {
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case TYPE_HOME:
                        return ResourcesWrapper.string.sipAddressTypeHome;
                    case TYPE_WORK:
                        return ResourcesWrapper.string.sipAddressTypeWork;
                    case TYPE_OTHER:
                        return ResourcesWrapper.string.sipAddressTypeOther;
                    default:
                        return ResourcesWrapper.string.sipAddressTypeCustom;
                }
            }
    ...
    protected interface GroupsColumns {
         ...
         * {@link CommonDataKinds.GroupMembership} in this group. Read-only
         * value that is only present when querying
    ...
    public static final class Groups implements BaseColumns, GroupsColumns, SyncColumns {
         ...
         * The content:// style URI for this table
         */
        public static final Uri EXCONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, "exgroups");
         ...
         * {@link ContactsContract.Data}.
         */
        public static final Uri EXCONTENT_SUMMARY_URI = Uri.withAppendedPath(AUTHORITY_URI,
                "exgroups_summary");
        ...
        /**
         * The "Family" system group.
         */
        public static final String GROUP_FAMILY = "Family";

        /**
         * The "Colleagues" system group.
         */
        public static final String GROUP_COLLEAGUES = "Colleagues";
        /**
         * The "Friends" system group.
         */
        public static final String GROUP_FRIENDS = "Friends";
        /**
         * The "Classmates" system group.
         */
        public static final String GROUP_CLASSMATES = "Classmates";
        /**
         * The "VIP" system group.
         */
        public static final String GROUP_VIP = "VIP";
        /**
         * The "Partners" system group.
         */
        public static final String GROUP_PARTNERS = "Partners";
    ...
    public static final class AggregationExceptions implements BaseColumns {
        ...
        /**
         * The MIME type of a {@link #CONTENT_URI} subdirectory of an
        ...
        /**
         * Allows the provider to automatically decide whether the specified raw
         * contacts should be included in the same aggregate contact or not.
         */
        ...
        /**
         * Makes sure that the specified raw contacts are NOT included in the
         * same aggregate contact.
         */
    ...
    protected interface SettingsColumns {
         ...
         * {@link CommonDataKinds.GroupMembership} entries should be visible in
         * any user interface.
         * <p>
         * Type: INTEGER (boolean)
         */
        ...
        /**
         * Read-only count of {@link Contacts} from a specific source that have
         * no {@link CommonDataKinds.GroupMembership} entries, and also have
         * phone numbers.
         * <p>
         * Type: INTEGER
         */
    ...
    /**
     * Helper methods to display QuickContact dialogs that allow users to pivot
     * on a specific {@link Contacts} entry.
     */
    public static final class QuickContact {
        ...
        /**
         * Medium QuickContact mode, includes actions and light summary
         * describing the {@link Contacts} entry being shown. This may include
         * social status and presence details.
         */
        public static final int MODE_MEDIUM = 2;

        /**
         * Large QuickContact mode, includes actions and larger, card-like
         * summary of the {@link Contacts} entry being shown. This may include
         * detailed information, such as a photo.
         */
        public static final int MODE_LARGE = 3;

        /**
         * Extra used to specify the last selected tab index of the Contacts
         * app. If this is not given or -1
         *
         * @hide
         */
        ...
        public static Intent getQuickContactIntent(Context context, View target, Uri lookupUri,
          ...
          //  final float appScale = context.getResources().getCompatibilityInfo().applicationScale;
            float appScale = 0;
            ResourcesWrapper mResourceWrapper = new ResourcesWrapper(context.getResources());
            try {
                appScale = mResourceWrapper.getCompatibilityInfo().applicationScale;
            } catch (WrapperNotSupportException wrapperE) {
                Log.e(TAG,"getCompatibilityInfo: catch an exception ", wrapperE);
            }
     ...
     * {@link android.content.Intent Intents} that involve contacts.
     */
    public static final class Intents {
        /**
         * This is the intent that is fired when a search suggestion is clicked
         * on.
         */
        ...
        /**
         * This is the intent that is fired when a search suggestion for dialing
         * a number is clicked on.
         */
        ...
        /**
         * Starts an Activity that lets the user pick a contact to attach an
         * image to. After picking the contact it launches the image cropper in
         * face detection mode.
         */
        ...
        public static final class UI {
            ...
            /**
             * The action for the "strequent" contacts list tab. It first lists
             * the starred contacts in alphabetical order and then the frequent
             * contacts in descending order of the number of times they have
             * been contacted.
             */
            ...
            /**
             * A key for to be used as an intent extra to set the activity title
             * to a custom String value.
             */
             ...
             * <p>
             * Input: Extra field {@link #FILTER_TEXT_EXTRA_KEY} is the text to
             * use for filtering
             * <p>
             * Output: Nothing.
             */
        ...
        /**
         * Convenience class that contains string constants used to create
         * contact {@link android.content.Intent Intents}.
         */
        public static final class Insert {
             ...
             * <P>
             * Type: Either an integer value from {@link CommonDataKinds.Phone},
             ...
             * <P>
             * Type: Either an integer value from {@link CommonDataKinds.Email}
             * or a string specifying a custom label.
             * </P>
             */
             ...
             * {@link CommonDataKinds.StructuredPostal} or a string specifying a
             * custom label.
             * </P>
             */
