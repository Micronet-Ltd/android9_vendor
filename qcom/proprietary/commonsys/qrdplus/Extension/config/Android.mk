...
ifeq (0,1)
ifeq ($(call is-board-platform-in-list, msm8996 msm8916 sdm660 msm8998 apq8098_latv msm8953 msm8937 sdm845 msmpeafowl sdm710 qcs605 msm8952 msm8909 msmnile $(MSMSTEPPE)),true)
...
InstallCarrier: $(OriginalBuildPropPath) $(FULL_SYSTEMIMAGE_DEPS) $(InstallCarrierSignTool) $(InstallCarrierSignPerm) $(InstallCarrierSignKey) BackupAllCarriers
