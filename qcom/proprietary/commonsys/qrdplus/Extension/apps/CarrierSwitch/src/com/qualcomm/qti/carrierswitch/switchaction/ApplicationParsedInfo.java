...
public class ApplicationParsedInfo extends ParsedInfo {
    static final String PARSER_TAG = "application";


    static private ApplicationParsedInfo.Parser mParser = new ApplicationParsedInfo.Parser();
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ApplicationParsedInfo: [");
    ...
    static class Parser extends ParsedInfo.Parser {
        @Override
        public ApplicationParsedInfo parse(XmlPullParser parser)
                throws XmlPullParserException, IOException {
            final int groupDepth = parser.getDepth();
            int type;
            ApplicationParsedInfo info = new ApplicationParsedInfo();
