...
#define PROP_MIN_FREQ_0    "vendor.min_freq_0"
#define PROP_MIN_FREQ_4    "vendor.min_freq_4"
...
void Target::InitializeTarget() {
    ...
    char *KernelVer = t.getKernelVersion();
    mKernelVersion = -1;
...
void invoke_tinyu_wa() {
  static struct {
      ...
      {"/proc/sys/kernel/sched_lib_name", "libunity.so"},
  };
  int rc;
