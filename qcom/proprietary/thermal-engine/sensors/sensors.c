...
static struct sensor_info bw_sensors[] = {
        {
                .name = "camera_bw",
                .setup = bw_sensors_setup,
                .shutdown = bw_sensors_shutdown,
                .get_temperature = bw_sensor_get_temperature,
                .interrupt_wait = bw_sensor_interrupt_wait,
...
#ifdef ENABLE_BW_SENSOR
	/* BW_SENSOR */
	if (add_tgt_sensors_set(bw_sensors,
                           ARRAY_SIZE(bw_sensors)) != 0) {
