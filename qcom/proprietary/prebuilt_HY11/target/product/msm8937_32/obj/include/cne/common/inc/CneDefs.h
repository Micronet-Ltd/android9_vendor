...
enum CommandId {
  ...
  NOTIFY_CA_CERTIFICATE_RESULT = 26,
  ...
  CAS_NOTIFY_CERTREQCB_DIED = 1015,
  CAS_REQUEST_CA_CERTIFICATE = 1016
};
...
typedef struct  _WlanInfo{
    ...
    _WlanInfo(): type(-1), status(-1), rssi(-127), netHdl(0),
        isAndroidValidated(false), freqBand(_2GHz), wifiState(WIFI_STATE_UNKNOWN), mode(CNE_WIFI_MODE_STA), wifiSwitchState(WIFI_SWITCH_STATE_UNKNOWN){
