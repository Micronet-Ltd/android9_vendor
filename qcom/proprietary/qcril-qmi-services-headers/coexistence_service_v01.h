...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.0.c1/Main/modem_proc/qmimsgs/coex/api/coexistence_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define COEX_V01_IDL_MINOR_VERS 0x1B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define COEX_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define COEX_V01_MAX_MESSAGE_ID 0x0045
/**
    @}
  */
...
typedef enum {
  ...
  COEX_LTE_INSTANCE1_V01 = 0, 
  COEX_LTE_INSTANCE2_V01 = 1, 
...
typedef struct {
  ...
  */
  ...
  /**<   \n  Note: If LTE2 is operating with carrier aggregation, this TLV
           reflects the configuration of the primary carrier.
  */
 ...
 */
  ...
  */
  ...
  /**<   LTE Instance the policy is set for. Values: \n
      - COEX_LTE_INSTANCE1 (0) -- 
      - COEX_LTE_INSTANCE2 (1) -- 
 \n
...
typedef struct {
  ...
  */
  ...
  /**<   Contains all 5 GHz LTE center frequencies. 
  */
