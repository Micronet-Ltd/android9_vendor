...
#define NAS_V01_IDL_MINOR_VERS 0xDF
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00D8
/**
    @}
  */
...
typedef enum {
  ...
  NAS_V2X_STATUS_CAUSE_OUT_OF_ALLOWED_GEOPOLYGON_V01 = 3, 
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
  uint8_t factory_data_1_valid;
  uint8_t factory_data_1[128];
}nas_get_factory_data_1_resp_v01;  /* Message */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
  uint8_t factory_data_3_valid;
  uint8_t factory_data_3[128];
}nas_get_factory_data_3_resp_v01;  /* Message */

typedef struct {
  /**<   Standard response type. */
  uint8_t factory_data_3[128];
}nas_set_factory_data_3_req_msg_v01;  /* Message */

typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}nas_set_factory_data_3_resp_msg_v01;  /* Message */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
  uint8_t meid_cd_valid;
  uint8_t meid_cd;
}nas_get_meid_cd_resp_v01;  /* Message */
...
typedef struct {
  /**<   Standard response type. */
  uint32_t meid[2];
}nas_set_meid_req_msg_v01;  /* Message */

typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}nas_set_meid_resp_msg_v01;  /* Message */

typedef struct {
  /**<   Standard response type. */
  uint8_t imei[16];
}nas_set_imei_req_msg_v01;  /* Message */

typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}nas_set_imei_resp_msg_v01;  /* Message */
...
typedef struct {
  ...
  uint8_t imei2_valid;
  uint8_t imei2[15];
}nas_get_imei2_resp_v01;  /* Message */
...
typedef struct {
  ...
  uint8_t imei1_valid;
  uint8_t imei1[15];
}nas_get_imei1_resp_v01;  /* Message */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
  uint8_t cu_reference_number_valid;
  uint8_t cu_reference_number[32];
}nas_get_cu_reference_number_resp_v01;  /* Message */
...
typedef struct {
  ...
  uint32_t oem_item_1[31];
}nas_get_oem_item_1_resp_v01;  /* Message */

typedef struct {
  /**<   Standard response type. */
  uint32_t oem_item_1[31];
}nas_set_oem_item_1_req_msg_v01;  /* Message */

typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}nas_set_oem_item_1_resp_msg_v01;  /* Message */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
  uint8_t oem_item_2_valid;
  uint32_t oem_item_2[31];
}nas_get_oem_item_2_resp_v01;  /* Message */

typedef struct {
  /**<   Standard response type. */
  uint32_t oem_item_2[31];
}nas_set_oem_item_2_req_msg_v01;  /* Message */

typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}nas_set_oem_item_2_resp_msg_v01;  /* Message */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
  uint8_t oem_item_3_valid;
  uint32_t oem_item_3[31];
}nas_get_oem_item_3_resp_v01;  /* Message */

typedef struct {
  /**<   Standard response type. */
  uint32_t oem_item_3[31];
}nas_set_oem_item_3_req_msg_v01;  /* Message */

typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}nas_set_oem_item_3_resp_msg_v01;  /* Message */
...
typedef struct {
  ...
  */
  ...
  /**<   List of the user-configured LTE bands, ordered by priority. The ordering 
       ...
       - 120 to 172 -- LTE band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
 ...
 */
 ...
 Values:      - NAS_V2X_STATUS_CAUSE_TIMING_INVALID (0) -- 
      ...
      - NAS_V2X_STATUS_CAUSE_OUT_OF_ALLOWED_GEOPOLYGON (3) -- 
 */
...
#define QMI_NAS_GET_FACTORY_DATA_1_REQ_MSG_V01 0x5556
#define QMI_NAS_GET_FACTORY_DATA_1_RESP_MSG_V01 0x5556
#define QMI_NAS_GET_FACTORY_DATA_3_REQ_MSG_V01 0x5557
#define QMI_NAS_GET_FACTORY_DATA_3_RESP_MSG_V01 0x5557
#define QMI_NAS_SET_FACTORY_DATA_3_REQ_MSG_V01 0x5558
#define QMI_NAS_SET_FACTORY_DATA_3_RESP_MSG_V01 0x5558
#define QMI_NAS_GET_MEID_CD_REQ_MSG_V01 0x5559
#define QMI_NAS_GET_MEID_CD_RESP_MSG_V01 0x5559
#define QMI_NAS_GET_CU_REFERENCE_NUMBER_REQ_MSG_V01 0x555A
#define QMI_NAS_GET_CU_REFERENCE_NUMBER_RESP_MSG_V01 0x555A
#define QMI_NAS_GET_OEM_ITEM_1_REQ_MSG_V01 0x555B
#define QMI_NAS_GET_OEM_ITEM_1_RESP_MSG_V01 0x555B
#define QMI_NAS_SET_OEM_ITEM_1_REQ_MSG_V01 0x555C
#define QMI_NAS_SET_OEM_ITEM_1_RESP_MSG_V01 0x555C
#define QMI_NAS_GET_OEM_ITEM_2_REQ_MSG_V01 0x555D
#define QMI_NAS_GET_OEM_ITEM_2_RESP_MSG_V01 0x555D
#define QMI_NAS_SET_OEM_ITEM_2_REQ_MSG_V01 0x555E
#define QMI_NAS_SET_OEM_ITEM_2_RESP_MSG_V01 0x555E
#define QMI_NAS_GET_OEM_ITEM_3_REQ_MSG_V01 0x555F
#define QMI_NAS_GET_OEM_ITEM_3_RESP_MSG_V01 0x555F
#define QMI_NAS_SET_OEM_ITEM_3_REQ_MSG_V01 0x5560
#define QMI_NAS_SET_OEM_ITEM_3_RESP_MSG_V01 0x5560
#define QMI_NAS_SET_MEID_REQ_MSG_V01 0x5561  //xiaciping add for setting MEID
#define QMI_NAS_SET_MEID_RESP_MSG_V01 0x5561  //xiaciping add for setting MEID
#define QMI_NAS_SET_IMEI_REQ_MSG_V01 0x5562  //xiaciping add for setting IMEI
#define QMI_NAS_SET_IMEI_RESP_MSG_V01 0x5562  //xiaciping add for setting IMEI
#define QMI_NAS_GET_IMEI2_REQ_MSG_V01 0x5563  //xiaciping add for getting IMEI
#define QMI_NAS_GET_IMEI2_RESP_MSG_V01 0x5563  //xiaciping add for getting IMEI
#define QMI_NAS_GET_IMEI1_REQ_MSG_V01 0x5564  //xiaciping add for getting IMEI
#define QMI_NAS_GET_IMEI1_RESP_MSG_V01 0x5564  //xiaciping add for getting IMEI
/**
    @}
  */
