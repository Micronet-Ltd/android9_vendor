...
#define DMS_V01_IDL_MINOR_VERS 0x3E
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DMS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DMS_V01_MAX_MESSAGE_ID 0x006A
/**
    @}
  */
...
typedef enum {
  ...
  DMS_PSM_VERSION_1_V01 = 1, /**<    Version1: AP decides the time that modem goes into PSM \n */
  DMS_PSM_VERSION_2_V01 = 2, /**< Version 2: Modem calculates and decides the time that it goes into PSM\n */
  DMS_PSM_VERSION_UNSPEC_V01 = 0xFF, /**< PSM Version unspecified. E.g. modem either does not support PSM feature or version 1 is 
...
typedef struct {
  ...
  */
  ...
  uint8_t secondary_sw_version__valid;  /**< Must be set to true if secondary_sw_version_ is being passed */
  char secondary_sw_version_[QMI_DMS_SW_VERSION_MAX_EXT_V01 + 1];
...
typedef struct {
  ...
  /**<   PSM version that the control point supports Values : \n
      ...
      - DMS_PSM_VERSION_1 (1) --    Version1: AP decides the time that modem goes into PSM \n
      - DMS_PSM_VERSION_2 (2) -- Version 2: Modem calculates and decides the time that it goes into PSM\n
      - DMS_PSM_VERSION_UNSPEC (0xFF) -- PSM Version unspecified. E.g. modem either does not support PSM feature or version 1 is 
        supported on an older modem that does not support negotiating PSM version. (Default value)
 */
...
typedef struct {
  ...
  /**<   PSM version honored by modem Values : \n
      - DMS_PSM_NOT_SUPPORTED (0) -- PSM is not supported on device >
      - DMS_PSM_VERSION_1 (1) --    Version1: AP decides the time that modem goes into PSM \n
      - DMS_PSM_VERSION_2 (2) -- Version 2: Modem calculates and decides the time that it goes into PSM\n
      - DMS_PSM_VERSION_UNSPEC (0xFF) -- PSM Version unspecified. E.g. modem either does not support PSM feature or version 1 is 
