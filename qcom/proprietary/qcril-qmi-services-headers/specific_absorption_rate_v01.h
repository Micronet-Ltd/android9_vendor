...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Fri Jan 25 2019 (Spin 0)
...
#define SAR_V01_IDL_MINOR_VERS 0x07
...
/** @addtogroup sar_qmi_consts
    @{
  */
#define SAR_MPE_MAX_MODULES_V01 8
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t module_id;
  /**<   ID of the module the power limit is being reported for */

  uint8_t enable_detection;
  /**<   Flag denoting whether detection is enabled for this module*/

  int32_t pmax_dbm_q7;
  /**<   Maximum power in Q7 format */

  int32_t pmax_dbm_q7_mimo;
  /**<   Maximum power in Q7 format for MIMO */
...
/** Indication Message; QMI service initiated transaction that signals power limit
               and backoff to QMI client which shall route it to WLAN
...
typedef struct {
  ...
  /**<  
    ...
    The QMI client shall mirror back the value in the 
  ...
  */
  ...
  /**<  
     Power backoff to be applied to the maximum transmit power for each of
     the WLAN transmission modes to ensure SAR compliance
     
     If the maximum transmit power limit is 14dBm, a backoff value of 30
     will result in the reduction of the limit to 11dBm.
  */
  ...
  /**<  
     Absolute Power Limit to be applied to the maximum transmit power for each of
     the WLAN transmission modes to ensure SAR compliance
     
     A value of 100 indicates a limit of 10dBm.
  */
...
typedef struct {
  ...
  /**<  
    ...
    QMI_SAR_WLAN_PWR_LIMIT_IND, the QMI client shall mirror back the
    value received in the indication.

    Else the QMI client shall generate a fresh value seq_num for each new 
...
typedef struct {
  ...
  */
  ...
  /**<  
    Sequence Number used for acknowledgement in the transaction.
    The QMI service shall mirror back the value received in the 
  ...
  */
  ...
  /**<  
     ...
     If the maxiumum transmit power limit is 14dBm, a backoff value of 30
     will result in the reduction of the limit to 11dBm.
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Request Message; QMI service initiated transaction that signals MPE power limits
               to QMI client which shall route it NR5G ML1 for exposure
			   compliance. */
typedef struct {
  ...
  /**<  
     MTPL information for each module reporting MPE limits
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Response Message; QMI service initiated transaction that signals MPE power limits
               to QMI client which shall route it NR5G ML1 for exposure
			   compliance. */
typedef struct {
