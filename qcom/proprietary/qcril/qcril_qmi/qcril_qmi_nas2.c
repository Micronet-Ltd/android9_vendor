    ...
    if ( RIL_E_SUCCESS == res )
    {
          ...
          switch ( android_mode_pref )
          {
              ...
              case QCRIL_PREF_NET_TYPE_TD_SCDMA_GSM_WCDMA_CDMA_EVDO_AUTO:
                  ...
                  break;
		/*xiaciping add for support 2G only 2017.06.13*/		  
              case QCRIL_PREF_NET_TYPE_CDMA_GSM:
                  set_system_selection_preference_req_msg.mode_pref = QMI_NAS_RAT_MODE_PREF_GSM_CDMA;
                  break;
