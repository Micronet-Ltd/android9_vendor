...
uint8_t qcril_dataconnectionservice_register_service (int instanceId);
...
*/
  ...
  uint8_t ret = qcril_dataconnectionservice_register_service(global_instance_id);
  QCRIL_LOG_INFO( "DataConnectionService res status: %d\n", ret);
