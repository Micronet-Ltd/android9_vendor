...
)
{
  ...
  unsigned int               emergencyProfileId = 0;
  ...
  else
  {
    ...
    if (useEmergencyProfile) {
      ...
      if (!setEmergencyDataCallParams(emergencyProfileId,
                                      emergencyPdnType,
                                      emergencyTechType,
                                      i))
      {
...
/*============================================================================
    ...
    qcril_data_retrieve_aid_from_app_info
...
*/
/*=========================================================================*/
int qcril_data_retrieve_aid_from_app_info
(
...
)
{
    ...
    QCRIL_LOG_FUNC_ENTRY();
    if (application && aid_buffer && app_type)
    {
            ...
            application->aid_ptr)
        {
            ...
            QCRIL_LOG_DEBUG("aid buffer = %s",aid_buffer);
...
/*============================================================================
    ...
    qcril_data_retrieve_aid_from_card_status
...
*/
/*=========================================================================*/
int qcril_data_retrieve_aid_from_card_status
(
    ...
    if (ril_card_status)
    {
        if (ril_card_status->card_state == RIL_CARDSTATE_PRESENT)
        {
            if (ril_card_status->gsm_umts_subscription_app_index != -1)
            {
                ...
                res = qcril_data_retrieve_aid_from_app_info(
