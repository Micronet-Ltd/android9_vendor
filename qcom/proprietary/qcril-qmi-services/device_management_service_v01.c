...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2006-2015, 2018 Qualcomm Technologies, Inc.
  All rights reserved.
...
static const uint8_t dms_get_sw_version_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_get_sw_version_resp_msg_v01, secondary_sw_version_) - QMI_IDL_OFFSET16RELATIVE(dms_get_sw_version_resp_msg_v01, secondary_sw_version__valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(dms_get_sw_version_resp_msg_v01, secondary_sw_version_),
  QMI_DMS_SW_VERSION_MAX_EXT_V01
};
