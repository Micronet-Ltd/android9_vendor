#======================================================================
#makefile for libmmcamera2_isp2_bpc47.so form mm-camera2
#======================================================================
...
LOCAL_SRC_FILES        := module_bpc47.c \
                          bpc47.c \
                          ../abcc_algo/abcc_algo.c
ifeq ($(OEM_CHROMATIX), true)
LOCAL_C_INCLUDES += $(LOCAL_EXTEN_ISP_INCLUDES)
LOCAL_SRC_FILES  += (shell find $(LOCAL_EXTEN_ISP_INCLUDES) -name 'bpc47_ext.c')
