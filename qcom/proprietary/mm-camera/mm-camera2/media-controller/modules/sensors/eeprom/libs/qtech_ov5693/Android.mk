QTECH_OV5693_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_qtech_ov5693_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(QTECH_OV5693_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= qtech_ov5693_eeprom.c
LOCAL_MODULE           := libmmcamera_qtech_ov5693_eeprom
