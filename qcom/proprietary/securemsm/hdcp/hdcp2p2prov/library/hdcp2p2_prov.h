...
#define HDCP2P2_CHAMOMILE_DPS_SIZE    16
#define HDCP2P2_KEY_FORMAT_CHAMOMILE  2
#define HDCP2P2_KEY_DATA_SET_SIZE     288

typedef struct HDCP2P2_chamomile_info_struct {
    uint8_t   DPS[HDCP2P2_CHAMOMILE_DPS_SIZE];
} HDCP2P2_chamomile_info_t;
