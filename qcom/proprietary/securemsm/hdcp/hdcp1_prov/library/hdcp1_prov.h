...
#define HDCP1_CMD_KEY_PROVISION             201
#define HDCP1_CMD_KEY_VERIFY                204

#define HDCP1_KEY_FORMAT_CLEAR_BIN          1
#define HDCP1_KEY_FORMAT_CHAMOMILE          2
#define HDCP1_KEY_FORMAT_CLEAR_BIN_NO_SHA1  3

#define HDCP1_CHAMOMILE_DPS_SIZE            16
#define HDCP1_KEY_DATA_SET_SIZE             288

typedef struct HDCP1_chamomile_info_struct {
        uint8_t        DPS[HDCP1_CHAMOMILE_DPS_SIZE];
} HDCP1_chamomile_info_t;
