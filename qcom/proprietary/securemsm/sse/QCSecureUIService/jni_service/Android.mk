...
COMMON_INCLUDES     := $(SSE_PATH)/log/inc \
		       ...
		       $(SECUREMSM_PATH)/qdutils_disp/1.0/hidl \
...
include $(CLEAR_VARS)
SSE_LOG_CFLAGS := -DLOG_TAG='"QCSecureUISvc_jni"'
...
LOCAL_SRC_FILES         := svc.cpp wfd.cpp  SecureDisplayAPI.cpp 
LOCAL_ADDITIONAL_DEPENDENCIES := $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
LOCAL_SHARED_LIBRARIES := liblog libsecureui_svcsock_system libcutils  libbinder libutils  libhidlbase libhidltransport  libhwbinder  libgui libui  vendor.qti.hardware.qdutils_disp@1.0 \
