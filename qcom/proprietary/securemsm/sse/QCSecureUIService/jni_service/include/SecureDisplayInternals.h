 ...
 * The code here was referenced from vendor/qcom/proprietary/mm-video-noship/vidc/vdec-omx/
  */
...
//    static const uint32_t DEFAULT_DISPLAY_WIDTH = 720;
  //  static const uint32_t DEFAULT_DISPLAY_HEIGHT = 1280;
