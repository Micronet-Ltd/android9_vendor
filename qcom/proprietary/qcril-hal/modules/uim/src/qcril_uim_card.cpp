...
)
{
  ...
  ril_card_status_ptr->iccid = NULL;
  ril_card_status_ptr->atr = NULL;
  if (ril_card_status_ptr->card_state == RIL_CARDSTATE_PRESENT)
  {
    ril_card_status_ptr->iccid = qcril_uim_util_iccid_to_string(
           card_status_ptr->card[slot].iccid,
           card_status_ptr->card[slot].iccid_len);

    ril_card_status_ptr->atr = qcril_uim_alloc_bin_to_hexstring(
...
)
{
  ...
  if (ril_card_status.iccid != NULL)
  {
    qcril_free(ril_card_status.iccid);
    ril_card_status.iccid = NULL;
  }

  if (ril_card_status.atr != NULL)
  {
    qcril_free(ril_card_status.atr);
    ril_card_status.atr = NULL;
  }
