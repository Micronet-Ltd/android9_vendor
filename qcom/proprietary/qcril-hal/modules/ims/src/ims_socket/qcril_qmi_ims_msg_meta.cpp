...
void qcril_qmi_ims_init_msg_meta()
{
    ...
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_SEND_SMS, ims_MsgType_REQUEST, NULL, sizeof(RIL_IMS_SMS_Message), QCRIL_EVT_IMS_SOCKET_REQ_SEND_SMS, "IMS_SEND_SMS" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_SEND_SMS, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_SEND_SMS" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_ACK_SMS, ims_MsgType_REQUEST, NULL, sizeof(QcrilImsSmsAckData), QCRIL_EVT_IMS_SOCKET_REQ_ACK_SMS, "IMS_ACK_SMS" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_ACK_SMS, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_ACK_SMS" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_ACK_SMS_REPORT, ims_MsgType_REQUEST, NULL, sizeof(QcrilImsSmsAckReportData), QCRIL_EVT_IMS_SOCKET_REQ_ACK_SMS_REPORT, "IMS_ACK_SMS_REPORT" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_ACK_SMS_REPORT, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_ACK_SMS_REPORT" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_REGISTER_MULTI_IDENTITY_LINES, ims_MsgType_REQUEST, NULL,
            sizeof(std::vector<QcrilImsMultiIdentityInfo>), QCRIL_EVT_IMS_SOCKET_REQ_REGISTER_MULTI_IDENTITY_LINES, "IMS_REGISTER_MULTI_IDENTITY_LINES" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_REGISTER_MULTI_IDENTITY_LINES, ims_MsgType_RESPONSE, NULL,
            0, QCRIL_EVT_NONE, "IMS_REGISTER_MULTI_IDENTITY_LINES" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_QUERY_VIRTUAL_LINE_INFO, ims_MsgType_REQUEST, NULL, sizeof(std::string), QCRIL_EVT_IMS_SOCKET_REQ_QUERY_VIRTUAL_LINE_INFO, "IMS_QUERY_VIRTUAL_LINE_INFO" });
    qcril_qmi_ims_msg_meta_data.push_back({ims_MsgId_REQUEST_QUERY_VIRTUAL_LINE_INFO, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_QUERY_VIRTUAL_LINE_INFO" });
