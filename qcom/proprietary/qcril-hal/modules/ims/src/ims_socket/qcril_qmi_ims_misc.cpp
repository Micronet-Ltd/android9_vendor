...
static std::map<qcril_evt_e_type, ims_MsgId> qcril_qmi_ims_event_msgid_map
{
    ...
    { QCRIL_EVT_IMS_SOCKET_REQ_SEND_SMS, ims_MsgId_REQUEST_SEND_SMS },

    { QCRIL_EVT_IMS_SOCKET_REQ_ACK_SMS, ims_MsgId_REQUEST_ACK_SMS },

    { QCRIL_EVT_IMS_SOCKET_REQ_ACK_SMS_REPORT, ims_MsgId_REQUEST_ACK_SMS_REPORT },

    { QCRIL_EVT_IMS_SOCKET_REQ_REGISTER_MULTI_IDENTITY_LINES, ims_MsgId_REQUEST_REGISTER_MULTI_IDENTITY_LINES },

    { QCRIL_EVT_IMS_SOCKET_REQ_QUERY_VIRTUAL_LINE_INFO, ims_MsgId_REQUEST_QUERY_VIRTUAL_LINE_INFO },
};
...
qcril_evt_e_type qcril_qmi_ims_map_request_to_event(ims_MsgId msg_id)
{
  ...
  switch ( msg_id )
  {
    ...
    case ims_MsgId_REQUEST_SEND_SMS:
      ret = QCRIL_EVT_IMS_SOCKET_REQ_SEND_SMS;
      break;

    case ims_MsgId_REQUEST_ACK_SMS:
      ret = QCRIL_EVT_IMS_SOCKET_REQ_ACK_SMS;
      break;

    case ims_MsgId_REQUEST_ACK_SMS_REPORT:
      ret = QCRIL_EVT_IMS_SOCKET_REQ_ACK_SMS_REPORT;
      break;

    case ims_MsgId_REQUEST_REGISTER_MULTI_IDENTITY_LINES:
      ret = QCRIL_EVT_IMS_SOCKET_REQ_REGISTER_MULTI_IDENTITY_LINES;
      break;

    case ims_MsgId_REQUEST_QUERY_VIRTUAL_LINE_INFO:
      ret = QCRIL_EVT_IMS_SOCKET_REQ_QUERY_VIRTUAL_LINE_INFO;
      break;
...
//===========================================================================
ims_CallFailCause qcril_qmi_ims_map_ril_failcause_to_ims_failcause(
    RIL_LastCallFailCause ril_failcause,
    int ims_extended_error_code,
...
)
{
  ...
  switch ( ims_extended_error_code )
  {
    ...
    case CALL_END_CAUSE_ALTERNATE_EMERGENCY_CALL_V02:
      ret = ims_CallFailCause_CALL_FAIL_SIP_ALTERNATE_EMERGENCY_CALL;
      break;

    case CALL_END_CAUSE_CODEC_ERROR_V02:
      ret = ims_CallFailCause_CALL_FAIL_MEDIA_INIT_FAILED;
      break;

    case CALL_END_CAUSE_RTP_RTCP_TIMEOUT_V02:
      ret = ims_CallFailCause_CALL_FAIL_MEDIA_NO_DATA;
      break;

    case CALL_END_CAUSE_UNSUPPORTED_SDP_V02:
    case CALL_END_CAUSE_RTP_FAILURE_V02:
      ret = ims_CallFailCause_CALL_FAIL_MEDIA_UNSPECIFIED_ERROR;
      break;

    case CALL_END_CAUSE_CSFB_NOT_FEASIBLE_IN_ROAM_CS_NW_V02:
      ret = ims_CallFailCause_CALL_FAIL_NO_CSFB_IN_CS_ROAM;
      break;

    case CALL_END_CAUSE_SRV_NOT_REGISTERED_V02:
      ret = ims_CallFailCause_CALL_FAIL_SRV_NOT_REGISTERED;
      break;
    case CALL_END_CAUSE_CALL_TYPE_NOT_ALLOWED_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_TYPE_NOT_ALLOWED;
      break;
    case CALL_END_CAUSE_EMRG_CALL_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_EMRG_CALL_ONGOING;
      break;
    case CALL_END_CAUSE_CALL_SETUP_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_SETUP_ONGOING;
      break;
    case CALL_END_CAUSE_MAX_CALL_LIMIT_REACHED_V02:
      ret = ims_CallFailCause_CALL_FAIL_MAX_CALL_LIMIT_REACHED;
      break;
    case CALL_END_CAUSE_UNSUPPORTED_SIP_HDRS_V02:
      ret = ims_CallFailCause_CALL_FAIL_UNSUPPORTED_SIP_HDRS;
      break;
    case CALL_END_CAUSE_CALL_TRANSFER_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_TRANSFER_ONGOING;
      break;
    case CALL_END_CAUSE_PRACK_TIMEOUT_V02:
      ret = ims_CallFailCause_CALL_FAIL_PRACK_TIMEOUT;
      break;
    case CALL_END_CAUSE_QOS_FAILURE_V02:
      ret = ims_CallFailCause_CALL_FAIL_QOS_FAILURE;
      break;
    case CALL_END_CAUSE_ONGOING_HANDOVER_V02:
      ret = ims_CallFailCause_CALL_FAIL_ONGOING_HANDOVER;
      break;
    case CALL_END_CAUSE_VT_WITH_TTY_NOT_ALLOWED_V02:
      ret = ims_CallFailCause_CALL_FAIL_VT_WITH_TTY_NOT_ALLOWED;
      break;
    case CALL_END_CAUSE_CALL_UPGRADE_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_UPGRADE_ONGOING;
      break;
    case CALL_END_CAUSE_CONFERENCE_WITH_TTY_NOT_ALLOWED_V02:
      ret = ims_CallFailCause_CALL_FAIL_CONFERENCE_WITH_TTY_NOT_ALLOWED;
      break;
    case CALL_END_CAUSE_CALL_CONFERENCE_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_CONFERENCE_ONGOING;
      break;
    case CALL_END_CAUSE_VT_WITH_AVPF_NOT_ALLOWED_V02:
      ret = ims_CallFailCause_CALL_FAIL_VT_WITH_AVPF_NOT_ALLOWED;
      break;
    case CALL_END_CAUSE_ENCRYPTION_CALL_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_ENCRYPTION_CALL_ONGOING;
      break;
    case CALL_END_CAUSE_INCOMING_REJ_CAUSE_CALL_ONGOING_CW_DISABLED_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_ONGOING_CW_DISABLED;
      break;
    case CALL_END_CAUSE_INCOMING_REJ_CAUSE_CALL_ON_OTHER_SUB_V02:
      ret = ims_CallFailCause_CALL_FAIL_CALL_ON_OTHER_SUB;
      break;
    case CALL_END_CAUSE_INCOMING_REJ_CAUSE_1X_COLLISION_V02:
      ret = ims_CallFailCause_CALL_FAIL_1X_COLLISION;
      break;
    case CALL_END_CAUSE_INCOM_REJ_CAUSE_UI_NOT_READY_V02:
      ret = ims_CallFailCause_CALL_FAIL_UI_NOT_READY;
      break;
    case CALL_END_CAUSE_CS_CALL_ONGOING_V02:
      ret = ims_CallFailCause_CALL_FAIL_CS_CALL_ONGOING;
      break;
    case CALL_END_CAUSE_PROTOCOL_Q850_ERROR_V02:
      ...
      {
        ret = ims_CallFailCause_CALL_FAIL_NORMAL_UNSPECIFIED;
      }
      break;
...
// Reason for inverted mapping.
    ...
    case ims_CallFailCause_CALL_FAIL_SIP_USER_MARKED_UNWANTED:
      res = VOICE_REJECT_CAUSE_UNWANTED_CALL_V02;
      break;
...
//===========================================================================
// qcril_qmi_voice_info_to_ims
//===========================================================================
ims_VoiceInfo qcril_qmi_voice_info_to_ims
(
...
)
{
    switch (qmi_voice_info)
    {
      case IMSA_VOICE_INFO_SILENT_V01:
        return ims_Voice_Info_SILENT;
      case IMSA_VOICE_INFO_SPEECH_V01:
        return ims_Voice_Info_SPEECH;
      default:
        return ims_Voice_Info_UNKNOWN;
    }
}

ims_VerstatVerificationStatus qcril_qmi_map_verstat_verification_state_to_ims(
...
void qcril_qmi_map_verstat_info_to_ims(
    ...
    ims_VerstatInfo& out) {
    out.canMarkUnwantedCall = in.network_supports_unwanted_call;
    out.verificationStatus =
        qcril_qmi_map_verstat_verification_state_to_ims(
                in.mt_call_verstat_info);
}
