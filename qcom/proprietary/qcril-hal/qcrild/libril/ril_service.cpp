...
int radio::getIccCardStatusResponse(int slotId,
    ...
    if (srvc) {
        return srvc->sendGetIccCardStatusResponse(slotId,
                responseType,
                serial,
                e,
                response,
...
int RadioImpl::convertGetIccCardStatusResponse(RadioResponseInfo &responseInfo,
...
int RadioImpl::sendGetIccCardStatusResponse(int slotId,
                                   int responseType, int serial, RIL_Errno e,
                                   void *response, size_t responseLen) {
    auto rsp = mRadioResponse;
    if (rsp != NULL) {
