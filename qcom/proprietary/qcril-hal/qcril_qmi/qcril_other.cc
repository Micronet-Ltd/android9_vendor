...
#include "qmi_ril_platform_dep.h" //xiaciping add 
...
static const qcril_other_nv_table_entry_type qcril_other_nv_table[] =
{
  ...
  { NV_FACTORY_DATA_1_I,        QCRIL_OTHER_NV_SO( factory_data_1 ),      (char*)"NV_FACTORY_DATA_1_I" },
  { NV_FACTORY_DATA_3_I,        QCRIL_OTHER_NV_SO( factory_data_3 ),      (char*)"NV_FACTORY_DATA_3_I" },
  { NV_MEID_CD_I,               QCRIL_OTHER_NV_SO( meid_cd ),             (char*)"NV_MEID_CD_I" },
  { NV_MEID_I,				QCRIL_OTHER_NV_SO( meid ),			  (char*)"NV_MEID_I" },
  { NV_VENDOR_TCL_CU_REFERENCE_NUMBER_I, QCRIL_OTHER_NV_SO( cu_reference_number ), (char*)"NV_VENDOR_TCL_CU_REFERENCE_NUMBER_I" },
  { NV_OEM_ITEM_1_I,            QCRIL_OTHER_NV_SO( oem_item_1 ),          (char*)"NV_OEM_ITEM_1_I" },
  { NV_OEM_ITEM_2_I,            QCRIL_OTHER_NV_SO( oem_item_2 ),          (char*)"NV_OEM_ITEM_2_I" },
  { NV_OEM_ITEM_3_I,            QCRIL_OTHER_NV_SO( oem_item_3 ),          (char*)"NV_OEM_ITEM_3_I" },
  { NV_UE_IMEI_I,            QCRIL_OTHER_NV_SO( imei ),          (char*)"NV_UE_IMEI_I" },
  { NV_UE_IMEI2_I,            QCRIL_OTHER_NV_SO( imei2 ),          (char*)"NV_UE_IMEI2_I" },
  { NV_UE_BT_ADDR_I,            QCRIL_OTHER_NV_SO( bt_mac_addr ),          (char*)"NV_UE_BT_ADDR_I" },
  { NV_UE_WLAN_ADDR_I,            QCRIL_OTHER_NV_SO( wlan_mac_addr ),          (char*)"NV_UE_WLAN_ADDR_I" },
  { NV_SET_SAR_RF_STATE_I,            QCRIL_OTHER_NV_SO( sar_rf_state ),          (char*)"NV_SET_SAR_RF_STATE_I" },
   ...
   do
   {
      ...
      case NV_FACTORY_DATA_1_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_FACTORY_DATA_1_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_FACTORY_DATA_3_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_FACTORY_DATA_3_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
         ...
         {  	
            ...
            if (QMI_NO_ERR !=
                qmi_client_send_msg_sync_with_shm(
                                        qcril_qmi_client_get_user_handle( QCRIL_QMI_CLIENT_DMS ),QMI_DMS_GET_DEVICE_SERIAL_NUMBERS_REQ_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof( get_config_resp_msg )
      ...
      case NV_MEID_CD_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_MEID_CD_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_VENDOR_TCL_CU_REFERENCE_NUMBER_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_CU_REFERENCE_NUMBER_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_OEM_ITEM_1_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_OEM_ITEM_1_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_OEM_ITEM_2_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_OEM_ITEM_2_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_OEM_ITEM_3_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_OEM_ITEM_3_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_UE_IMEI_I:
         {  	
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_IMEI1_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_UE_IMEI2_I:
         {
            ...
            if (QMI_NO_ERR !=
                qmi_client_nas_send_sync(QMI_NAS_GET_IMEI2_REQ_MSG_V01,
                                               NULL,
                                               0,
                                               &get_config_resp_msg,
                                               sizeof(get_config_resp_msg)
      ...
      case NV_UE_BT_ADDR_I:
		...
		addr_req.device = DMS_DEVICE_MAC_BT_V01;
            ...
            if (QMI_NO_ERR !=
                qmi_client_send_msg_sync_with_shm(
                                        qcril_qmi_client_get_user_handle( QCRIL_QMI_CLIENT_DMS ),QMI_DMS_GET_MAC_ADDRESS_REQ_V01, &addr_req, sizeof(addr_req),
	      ...
	      qmi_client_error =
                qmi_client_send_msg_sync_with_shm(
                                        qcril_qmi_client_get_user_handle( QCRIL_QMI_CLIENT_RF_SAR ),
			                                     ...
			                                     sizeof( qmi_request ),
			                                     (void*) &qmi_response,
			                                     sizeof( qmi_response ),QCRIL_QMI_SYNC_REQ_DEF_TIMEOUT );
